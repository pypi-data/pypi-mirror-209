...
class FastdupVisualizer:
    ...
    def _compute_label_col(self, label_col):
        if self._controller._df_annot is not None and not self._controller._df_annot.empty and ('label' in self._controller._df_annot.columns) and label_col is None:
    ...
    def outliers_gallery(self, save_path: str = None, label_col: str = None, draw_bbox: bool = False,
        ...
        label_col = self._compute_label_col(label_col)
