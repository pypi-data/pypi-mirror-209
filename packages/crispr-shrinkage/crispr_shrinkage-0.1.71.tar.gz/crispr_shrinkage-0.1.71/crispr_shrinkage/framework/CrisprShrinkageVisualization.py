...
class CrisprShrinkageVisualizationInput:
    ...
    observational_positions: List[Union[float, int]]
...
def prepare_crispr_shrinkage_visualization_input(crispr_shrinkage_result: CrisprShrinkageResult, use_rescaled: bool = True):
    ...
    explanatory_guides = [guide for guide in np.concatenate([crispr_shrinkage_result.adjusted_observation_guides, crispr_shrinkage_result.adjusted_positive_control_guides, crispr_shrinkage_result.adjusted_negative_control_guides]) if (guide.is_explanatory == True) and (guide.position is not None)]
    ...
    observational_positions = np.asarray([guide.position for guide in crispr_shrinkage_result.adjusted_observation_guides])
    ...
    crispr_shrinkage_visualization_input = CrisprShrinkageVisualizationInput(
        ...
        observational_positions=observational_positions,
