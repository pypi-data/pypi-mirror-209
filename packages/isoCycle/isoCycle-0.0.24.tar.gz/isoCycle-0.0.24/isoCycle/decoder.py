...
def cycleDetection(spikeTimes, decoderAdd='isoCycle/model/isoCycle_publishedModel_2022-06-28.pkl',\
        regionName='V1', cycleName='gamma', wholeSession=False, cycleDetectionDur=10, detectionThreshold=0.035,\
            inputName='populationSpiking', interCycleIntervalFig=True, spikeDistAroundCycles=True,\
                cycleNoForSpikeDisFig=5000, distWindowLenghtPerCycle=3, binsPerCycle=30,spikingDistShowSlider = False,\
                    ):
    ...
    '''
         ...
         inputs:
            ...
            cycleNoForSpikeDisFig      : default: 200 - Number of the detected cycles used to generate the spike distribution around the cycles
    ...
    detectedCyclesTimes = detectedCyclesTimes + decoderInput_timePoints[binsBefore] + dt
...
def loadDecoder(decoderAdd, modelEvaluation=False, n=0):
    ...
    decoderAdd = pkg_resources.resource_filename('isoCycle', "model/isoCycle_publishedModel_2022-06-28.pkl")
