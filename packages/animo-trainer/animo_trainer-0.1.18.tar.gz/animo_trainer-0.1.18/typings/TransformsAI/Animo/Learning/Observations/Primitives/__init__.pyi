...
class BoolObservation(Observation):
    def __init__(self, parent: Observation, perceive: Func_2[Character, bool], name: str = ...) -> None: ...
    @property
    def Name(self) -> str: ...
    @property
...
class FloatObservation(Observation):
    def __init__(self, parent: Observation, perceive: Func_2[Character, float], name: str = ...) -> None: ...
    @property
    def Name(self) -> str: ...
    @property
    def ObservationCount(self) -> int: ...
...
class OneHotObservation_1(typing.Generic[OneHotObservation_1_T], CompositeObservation):
    def __init__(self, parent: Observation, name: str, perceive: Func_2[Character, OneHotObservation_1_T], options: Array_1[OneHotObservation_1_T], labels: Array_1[str]) -> None: ...
    @property
    def InnerObservations(self) -> Array_1[Observation]: ...
    @property
    def Name(self) -> str: ...
...
class Vector3Observation(CompositeObservation):
    def __init__(self, parent: Observation, perceive: Func_2[Character, Vector3], name: str = ...) -> None: ...
    @property
    def InnerObservations(self) -> Array_1[Observation]: ...
    @property
    def Name(self) -> str: ...
