...
class HhousenDocsumModel(Model):
    ...
    def inference(self, input_pdf: BinaryIO, model: str = 'bart', bart_checkpoint: str = None, bart_state_dict_key: str = 'model', bart_fairseq: bool = False, chapter_heading_font: int = 0, body_heading_font: int = 3, body_font: int = 1) -> bytes:
        """
