...
@pytest.mark.asyncio
async def test_retry(fail_count: int):
...
@pytest.mark.asyncio
async def test_raise_exception(fail_count: int):
...
@pytest.mark.asyncio
async def test_retry_tries_number(tries: int):
...
@pytest.mark.asyncio
async def test_retry_timeout(timeout: float, execution_time: float, overhead: float = 0.01):
...
@pytest.mark.asyncio
async def test_retry_delay(delay: float, fail_count: int, execution_time: float, overhead: float = 0.01):
...
@pytest.mark.asyncio
async def test_retry_with_exception():
