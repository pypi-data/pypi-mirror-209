...
def sitemap_tree_for_homepage(homepage_url: str,
                              web_client: Optional[AbstractWebClient] = None,
                              logger: Logger = None) -> AbstractSitemap:
    """
    ...
    if homepage_url != stripped_homepage_url:
        print_warn(logger, "Assuming that the homepage of {} is {}".format(homepage_url, stripped_homepage_url))
