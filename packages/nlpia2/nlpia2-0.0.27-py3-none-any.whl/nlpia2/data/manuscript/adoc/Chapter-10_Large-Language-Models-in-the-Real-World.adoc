...
* _Environmental impact_:: LLMs are notoriously wasteful and polluting footnote:[ChatGPT carbon footpring estimate on Towards Data Science (https://12ft.io/proxy?&q=https%3A%2F%2Ftowardsdatascience.com%2Fthe-carbon-footprint-of-chatgpt-66932314627d)] footnote:[Tool for estimating ML model environmental impact (https://mlco2.github.io/impact/)]

You can mitigate all these harms by building and using LLMs that are smarter and more efficient.
That's what this chapter is about.
Your will soon learn how to build LLMs that generate more intelligent, trustworthy, equitable words.
And you will learn how to make your LLMs more efficient and less wasteful, not only reducing the engironmental impact but also helping more people gain access to the power of LLMs.
