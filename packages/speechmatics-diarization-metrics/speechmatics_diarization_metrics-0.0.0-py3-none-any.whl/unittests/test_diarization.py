...
from aladdin.diarization.metrics.sm_diarisation_metrics.metrics.diarization import (
    DiarizationCoverage,
...
def test_jaccard_error_rate(reference, hypothesis):
    diarizationErrorRate = JaccardErrorRate()
    error_rate = diarizationErrorRate(reference, hypothesis)
    npt.assert_almost_equal(error_rate, 0.4351, decimal=3)
