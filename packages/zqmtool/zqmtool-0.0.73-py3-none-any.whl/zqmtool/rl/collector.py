...
def get_new_trajactory_len(buffers, env_id, ep_len, relabelling_strategy, goal_id_2_room_dict):
    ...
    for index, achieved_goal_id_i in enumerate(achieved_goal_id):
        ...
        if relabelling_strategy == 'min_length':
            ...
            if goal_id_2_room_dict[unique_desired_goal_id] != goal_id_2_room_dict[achieved_goal_id_i]:
                continue
            length = np.amin(length_candidate)
...
class HERCollector(Collector):
    def __init__(self,
        ...
        self.goal_id_2_room_dict = env.workers[0].env.goal_id_2_room_dict
            ...
            if np.any(done):
                ...
                for env_id in env_ind_global:  # enumerate env
                    ...
                    new_trajactory_len, original_trajectory = get_new_trajactory_len(
                        ...
                        goal_id_2_room_dict=self.goal_id_2_room_dict,
                    )
