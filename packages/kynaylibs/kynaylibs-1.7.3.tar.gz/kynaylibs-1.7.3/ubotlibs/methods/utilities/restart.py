...
class Restart:
    async def restart(self: "ubotlibs.Client", block: bool = True):
        """Restart the Client.

        This method will first call :meth:`~ubotlibs.Client.stop` and then :meth:`~ubotlibs.Client.start` in a row in
        ...
        Returns:
            :obj:`~ubotlibs.Client`: The restarted client itself.
