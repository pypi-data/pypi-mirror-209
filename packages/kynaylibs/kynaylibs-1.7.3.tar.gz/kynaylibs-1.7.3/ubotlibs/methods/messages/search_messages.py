...
class SearchMessages:
    ...
    async def search_messages(
        ...
        If you want to get the messages count only, see :meth:`~ubotlibs.Client.search_messages_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~ubotlibs.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~ubotlibs.types.Message` objects.
