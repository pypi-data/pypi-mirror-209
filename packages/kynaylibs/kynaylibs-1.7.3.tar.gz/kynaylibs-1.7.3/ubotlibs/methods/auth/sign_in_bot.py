...
from ubotlibs.errors import UserMigrate
...
class SignInBot:
    async def sign_in_bot(self: "ubotlibs.Client", bot_token: str) -> "types.User":
        ...
        Returns:
            :obj:`~ubotlibs.types.User`: On success, the bot identity is return in form of a user object.
