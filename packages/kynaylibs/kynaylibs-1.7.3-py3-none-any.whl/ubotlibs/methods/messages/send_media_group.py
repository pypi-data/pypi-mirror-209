...
import ubotlibs
from ubotlibs import raw, types, utils
...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~ubotlibs.types.InputMediaPhoto`, :obj:`~ubotlibs.types.InputMediaVideo`, :obj:`~ubotlibs.types.InputMediaAudio` and :obj:`~ubotlibs.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~ubotlibs.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from ubotlibs.types import InputMediaPhoto, InputMediaVideo
