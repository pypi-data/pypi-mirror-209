...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~ubotlibs.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~ubotlibs.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~ubotlibs.types.BotCommand`: On success, the list of bot commands is returned.
