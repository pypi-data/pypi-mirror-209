...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~ubotlibs.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <ubotlibs.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~ubotlibs.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~ubotlibs.types.InlineQueryResult`):
