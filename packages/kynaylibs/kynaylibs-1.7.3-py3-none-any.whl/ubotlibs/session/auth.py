...
from ubotlibs.crypto import aes, prime, rsa
from ubotlibs.errors import SecurityCheckMismatch
from ubotlibs.raw.core import Int, Long, TLObject
...
class Auth:
    ...
    def __init__(self, client: "ubotlibs.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
