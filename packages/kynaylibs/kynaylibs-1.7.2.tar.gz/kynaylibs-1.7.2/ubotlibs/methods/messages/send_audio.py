...
import ubotlibs
from ubotlibs import StopTransmission, enums, raw, types, utils
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~ubotlibs.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~ubotlibs.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
