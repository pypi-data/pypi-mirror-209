...
import ubotlibs
from ubotlibs.methods.utilities.idle import idle


class Run:
    def run(self: "ubotlibs.Client", coroutine=None):
        """Start the client, idle the main script and finally stop the client.

        When calling this method without any argument it acts as a convenience method that calls
        :meth:`~ubotlibs.Client.start`, :meth:`~ubotlibs.idle` and :meth:`~ubotlibs.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`ubotlibs.compose`.
