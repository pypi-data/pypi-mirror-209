...
from ubotlibs.errors import PeerIdInvalid
...
class ResolvePeer:
    async def resolve_peer(
        self: "ubotlibs.Client", peer_id: Union[int, str]
        ...
        .. note::
            ...
            :obj:`functions <ubotlibs.api.functions>` (i.e: a Telegram API method you wish to use which is not
