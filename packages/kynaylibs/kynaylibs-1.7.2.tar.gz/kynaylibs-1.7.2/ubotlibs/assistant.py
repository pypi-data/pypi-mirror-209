...
from ubotlibs import filters
from ubotlibs.handlers import CallbackQueryHandler, InlineQueryHandler
from ubotlibs.types import (InlineKeyboardButton, InlineKeyboardMarkup,
...
IN_BTTS = [
    [
        ...
        InlineKeyboardButton("Support", url="https://t.me/ubotSupport"),
    ]
]
...
def inline(
    ...
    filterm = filters.regex(pattern=pattern)
        ...
        async def wrapper(tgbot, cq):
            ...
            if client_only and not await list_all_client():
                return await cq.answer(
                    "Ini Bukan Userbot Anda, Silahkan Buat Userbot Anda Di @ubotSupport",
                    show_alert=True,
                )
            if admins and not await is_admin_or_owner(cq.message, from_users):
                return await cq.answer(
                    "Anda Bukan Admin...",
                    show_alert=True,
                )
