...
import ubotlibs
from ubotlibs import raw, types
...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~ubotlibs.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~ubotlibs.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~ubotlibs.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~ubotlibs.types.CallbackGame`, *optional*):
