...
class ImportContacts:
    async def import_contacts(
        self: "ubotlibs.Client", contacts: List["types.InputPhoneContact"]
    ):
        ...
        Parameters:
            contacts (List of :obj:`~ubotlibs.types.InputPhoneContact`):
        ...
        Example:
            .. code-block:: python
                ...
                from ubotlibs.types import InputPhoneContact
