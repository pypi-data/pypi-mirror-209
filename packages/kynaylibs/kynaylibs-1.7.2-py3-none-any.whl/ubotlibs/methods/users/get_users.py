...
class GetUsers:
    async def get_users(
        self: "ubotlibs.Client", user_ids: Union[int, str, Iterable[Union[int, str]]]
        ...
        Returns:
            :obj:`~ubotlibs.types.User` | List of :obj:`~ubotlibs.types.User`: In case *user_ids* was not a list,
