...
class GetChat:
    async def get_chat(
        self: "ubotlibs.Client", chat_id: Union[int, str]
        ...
        Returns:
            :obj:`~ubotlibs.types.Chat` | :obj:`~ubotlibs.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
