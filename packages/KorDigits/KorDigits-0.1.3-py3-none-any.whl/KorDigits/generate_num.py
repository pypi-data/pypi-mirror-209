    ...
    def _label_0(self, tagging):
        ...
        if '시간' in output:
            ...
            if re.search(hour_regex, output):
                hours = re.findall(hour_regex, output)
                for hour in hours:
                    if hour == '0':
                        hour_string = '영'
                    else:
        ...
        if re.search(minute_regex, output):
            minute = re.search(minute_regex, output).group()[:-1] if '여' not in output else re.search(minute_regex,
                                                                                                      output).group()[
                                                                                            :-2]
            # '분' 십의 자리 숫자
            if minute == '0':
...
if __name__ == '__main__':
    ...
    label2num = Label2Num()
    print(label2num.generate("5시간9시간"))
