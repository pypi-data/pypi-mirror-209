...
class NotebookHandler {
    ...
    createNewEmptyScene(scene_name, activate_new_scene = true) {
...
class ScenesSidebar extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    ...
    _setupGlobalCommands() {
        this._app.commands.addCommand('scenes:test', {
            label: 'Test',
            execute: (args) => { console.log('Test', args); }
        });
...
//# sourceMappingURL=lib_index_js.f465585239b61c842ee4.js.map