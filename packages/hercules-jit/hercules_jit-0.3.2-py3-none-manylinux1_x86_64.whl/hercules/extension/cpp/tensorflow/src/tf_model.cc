...
#if defined(HERCULES_SCRIPT_TENSORFLOW_PYTHON_MODE) && TF_MAJOR_VERSION == 1
...
#ifdef HERCULES_SCRIPT_TENSORFLOW_PYTHON_MODE
...
HERCULES_REGISTER_NATIVE_OP(TFModel);
...
HERCULES_REGISTER_NATIVE_OBJECT(TensorProtoSerializer)
