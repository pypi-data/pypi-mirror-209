...
class Set(Object):
    """hercules.Set: hercules.Set implemented refering to python built-in dict,
    ...
    def update(self, *args, **kwargs):
        ...
        Examples:
            >>> import hercules
            >>> a = hercules.Set({'a', 'b', 'c'})
            >>> a.update(hercules.Set({'b', 'd'}), {'e', 'f'}, ['a', 1], hercules.List([1, 2]))
            >>> a
            {'a', 'c', 'd', 2, 'b', 'f', 1, 'e'}
        """
    ...
    def difference(self, *args):
        ...
        Examples:
            >>> import hercules
            >>> s = hercules.Set({'a', 'b', 'c', 'd', 'e', 'f'})
            >>> s.difference(hercules.Set({'a', 'b'}), {'d', 1}, ['f'], hercules.List([2]))
            {'c', 'e'}
            >>> s
            {'a', 'd', 'c', 'b', 'f', 'e'}
        """
    ...
    def difference_update(self, *args):
        ...
        Examples:
            >>> s = hercules.Set({'a', 'b', 'c', 'd', 'e', 'f'})
            >>> s.difference_update(hercules.Set({'a', 'b'}), {'d', 1}, ['f'], hercules.List([2]))
            >>> s
            {'c', 'e'}
        """
    ...
    def union(self, *args, **kwargs):
        ...
        Examples:
            >>> import hercules
            >>> a = hercules.Set({'a', 'b', 'c'})
            >>> a.union(hercules.Set({'b', 'd'}), {'e', 'f'}, ['a', 1], hercules.List([1, 2]))
            {'a', 'c', 'd', 2, 'b', 'f', 1, 'e'}
            >>> a
            {'a', 'c', 'b'}
        """
