...
class List(Object):
    """hercules.List implemented refering to python built-in list,
    ...
    List(iterable) -> construct list from iterable object
        >>> import hercules
        >>> l = hercules.List([1, 2, 3])
        >>> print(l)
        [1, 2, 3]
        >>> l1 = hercules.List([1, 2, 3])
        >>> l2 = hercules.List(l1)
        >>> print(l2)
        [1, 2, 3]
    """
