...
class Dict(Object):
    """hercules.Dict implemented refering to python built-in dict,
    ...
    def items(self):
        """Return a key-value iterable (hercules.Iterator).
        ...
        Examples:
            ...
            >>> it = d.items()
            >>> type(it)
            <class 'hercules.runtime._container._iterator.Iterator'>
            >>> for k, v in it:
            ...     print(k, v)
            ...
            a 1
    ...
    def pop(self, k, *args):
        ...
        Examples:
            ...
            File "/data00/shubaihan/repos/hercules4/python/hercules/runtime/_container/_dict.py", line 223, in pop
                return _ffi_api.DictPop(self, k, *args)
            TypeError: HERCULESError: dict.pop KeyError
            Stack trace:
            File "/data00/shubaihan/repos/hercules4/src/runtime/container/dict_ref.cc", line 305
            [bt] (0) /data00/shubaihan/repos/hercules4/lib/libhercules.so(+0x33c9ed) [0x7f70d4ad39ed]
            [bt] (1) /data00/shubaihan/repos/hercules4/lib/libhercules.so(hercules::runtime::Dict::pop(hercules::runtime::PyArgs)+0x92) [0x7f70d4ad5362]
            [bt] (2) /data00/shubaihan/repos/hercules4/lib/libhercules.so(+0x33f434) [0x7f70d4ad6434]
            [bt] (3) /data00/shubaihan/repos/hercules4/lib/libhercules.so(HERCULESFuncCall_PYTHON_C_API+0x45) [0x7f70d4ab8c45]
        """
        return _ffi_api.DictPop(self, k, *args)
