...
def register_object(type_key=None, callback=None):
    ...
    .. code-block:: python
      ...
      @hercules.register_object("test.MyObject")
...
def register_func(func_name, f=None, override=False):
    ...
    .. code-block:: python
      ...
      targs = (10, 10.0, "hello")
      @hercules.register_func
      def my_packed_func(*args):
          assert(tuple(args) == targs)
          return 10
      # Get it out from global function table
      f = hercules.get_global_func("my_packed_func")
      assert isinstance(f, hercules.PackedFunc)
      y = f(*targs)
      assert y == 10
    """
...
def _init_api(namespace, target_module_name=None):
    ...
    if namespace.startswith("hercules."):
