...
from hercules.script import context as script_context
...
class ForLoopParser(BaseParser):
    ...
    def _make_for_loop_compute_block(self, rt_ir, span):
        ...
        body = _ir.SeqStmt([i.to_hercules_ir() for i in rt_ir])
    ...
    def _make_range(self):
        ...
        for key, r in self.loop_variable_map.items():
            rng.append(RangeExpr(r[0].to_hercules_ir(), r[1].to_hercules_ir(), r[2].to_hercules_ir()))
        return rng
