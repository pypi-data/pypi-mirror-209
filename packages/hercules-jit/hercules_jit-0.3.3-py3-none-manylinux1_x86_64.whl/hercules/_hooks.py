...
def _hercules_wrap_excepthook(exception_hook):
...
sys.excepthook = _hercules_wrap_excepthook(sys.excepthook)


# Enhance default JSONEncoder for HERCULES support
class _Encoder(json.JSONEncoder):
    def encode(self, o) -> str:
        from .runtime import _ffi_api
        from hercules.runtime import List, Dict, Set, Tuple
    ...
    def default(self, obj):
        from hercules.runtime import List, Dict, Tuple
