...
class PackedFunc(PackedFuncBase):
    """The PackedFunc object used in HERCULES.

    Function plays an key role to bridge front and backend in HERCULES.
    ...
    HERCULES backend also registers and exposes its API as Functions.

    The following are list of common usage scenario of hercules.runtime.PackedFunc.
    ...
    See Also
    --------
    hercules.register_func: How to register global function.
    hercules.get_global_func: How to get global function.
    """
