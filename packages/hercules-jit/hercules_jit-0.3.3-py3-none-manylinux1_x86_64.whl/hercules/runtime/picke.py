...
def serialize(v):
    warnings.warn("The function hercules.serialize is deprecated.", DeprecationWarning)
...
def deserialize(s: str):
    warnings.warn("The function hercules.deserialize is deprecated.", DeprecationWarning)
