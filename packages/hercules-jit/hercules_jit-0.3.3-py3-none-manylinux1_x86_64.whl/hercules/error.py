...
# under the License.
"""Structured error classes in HERCULES.
...
class InternalError(TError):
    ...
    def __init__(self, msg):
        ...
        if "HERCULES hint:" not in msg:
            msg += ("\nHERCULES hint: You hit an internal error. " +
                    "Please open a thread on nlp/hercules to report it.")
