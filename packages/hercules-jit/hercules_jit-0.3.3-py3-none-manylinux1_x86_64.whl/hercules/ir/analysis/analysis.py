...
def expr_deep_equal(lhs, rhs):
    ...
    Use py:func:`hercules.ir.structural_equal` to handle structural variable remapping.

    Due to the restriction of not remapping variables, this function can run
    faster than StructuralEqual and can be used as a utility function during arithmetic
    simplifications.

    Always consider py:func:`hercules.ir.structural_equal` first, which handles
    the structural remapping.

    See Also
    --------
    hercules.ir.structural_equal
    """
