...
def _register_builtin_container_cons(name_hint, hercules_name_hint, ret_type):
    Builtin2Op.registrations[name_hint] = _ir_adt.Constructor(hercules_name_hint, ret_type=ret_type)
...
_register_python_builtin("math.exp2", "hercules_math_exp2")
_register_python_builtin("math.exp10", "hercules_math_exp10")
_register_python_builtin("math.erf", "math_erf")
_register_python_builtin("math.tanh", "math_tanh")
_register_python_builtin("math.sigmoid", "hercules_math_sigmoid")
...
_register_python_builtin("math.rsqrt", "hercules_math_rsqrt")
...
_register_python_builtin("math.nearbyint", "hercules_math_nearbyint")
...
# ndarray
_register_python_builtin("{}.runtime.ndarray.add".format("hercules"), "nd_module_add")
_register_python_builtin("{}.runtime.ndarray.sub".format("hercules"), "nd_module_sub")
_register_python_builtin("{}.runtime.ndarray.div".format("hercules"), "nd_module_div")
_register_python_builtin("{}.runtime.ndarray.mul".format("hercules"), "nd_module_mul")
_register_python_builtin("{}.runtime.ndarray.rand".format("hercules"), "nd_module_rand")
_register_python_builtin("{}.runtime.ndarray.concatenate".format("hercules"), "nd_module_concatenate")
_register_python_builtin("{}.runtime.ndarray.stack".format("hercules"), "nd_module_stack")

# TODO: support heapq
_register_python_builtin("{}.list_sort".format("hercules"), "list_module_sort")
_register_python_builtin(
    "{}.runtime._container._list.heapify".format("hercules"),
    "list_module_heapify")
_register_python_builtin(
    "{}.runtime._container._list.heap_replace".format("hercules"),
    "list_module_heap_replace")
_register_python_builtin(
    "{}.runtime._container._list.heap_pushpop".format("hercules"),
    "list_module_heap_pushpop")
_register_python_builtin(
    "{}.runtime._container._list.nth_element".format("hercules"),
    "list_module_nth_element")

# cuda_stream
_register_python_builtin(
    "{}.runtime.cuda_stream.default_stream".format("hercules"),
    "cuda_module_default_stream")
_register_python_builtin(
    "{}.runtime.cuda_stream.create_stream".format("hercules"),
    "cuda_module_create_stream")
_register_python_builtin(
    "{}.runtime.cuda_stream.stream_sync".format("hercules"),
...
# hercules.xx_func
_register_op(make_native_object, _ir_op.hercules_make_native_object)
_register_op("{}.native.make_native_op".format(_module_name_), _ir_op.hercules_make_native_op)
_register_op(make_native_function, _ir_op.hercules_make_native_function)
_register_op(call_native_function, _ir_op.hercules_call_native_function)
_register_op("{}.pmap".format(_module_name_), _ir_op.hercules_pmap)
_register_op("{}.pstarmap".format(_module_name_), _ir_op.hercules_pstarmap)
_register_op("{}.apply_async".format(_module_name_), _ir_op.hercules_apply_async)
...
def register_tuple_construct():
    ...
    def tuple_construct(args):
        ...
        # should be unpacked *args, e.g. hercules.Tuple(1, 2, 3) or (1, 2, 3).
    ...
    Builtin2Op.registrations["hercules.runtime.container.Tuple"] = tuple_star_construct
...
def _register_regex_construct():
    ...
    Builtin2Op.registrations["hercules.runtime.regex.Regex"] = regex_construct
...
def _register_nd_array_construct():
    ...
    Builtin2Op.registrations["hercules.runtime.ndarray.NDArray"] = nd_array_construct
