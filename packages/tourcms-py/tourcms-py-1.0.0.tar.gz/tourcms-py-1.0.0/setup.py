...
setup(name='tourcms-py',
      ...
      long_description="A simple wrapper for connecting to the TourCMS Marketplace API (http://www.tourcms.com/support/api/mp/). Forked from /prio/tourcms. This wrapper mirrors the TourCMS PHP library. See https://github.com/TourCMS/tourcms-py for more details.",
