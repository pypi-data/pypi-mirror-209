...
class JupyterAppsHandler(JupyterHandler):
    """JupyterAppsHandler"""
    ...
    def get(self):
        self.finish(json.dumps({
            "data": "This is /jupyter_apps/get_example endpoint!"
        }))
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_apps", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_apps", "echo")
    handlers = [
        (route_pattern, JupyterAppsHandler),
