"use strict";
(self["webpackChunk_datalayer_jupyter_apps"] = self["webpackChunk_datalayer_jupyter_apps"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'jupyter_apps', // API Namespace
    endPoint);
    let response;
    try {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "IJupyterApps": () => (/* binding */ IJupyterApps),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "jupyterApps": () => (/* binding */ jupyterApps)
/* harmony export */ });
...
const IJupyterApps = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_5__.Token('@datalayer/jupyter-apps:plugin');
const jupyterApps = {
...
var CommandIDs;
(function (CommandIDs) {
    CommandIDs.create = 'create-jupyter-apps-widget';
...
const plugin = {
    ...
    activate: (app, palette, jupyterDocker, settingRegistry, launcher) => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_9__.requestAPI)('get_example')
            ...
            .catch(reason => {
            console.error(`The jupyter_apps server extension appears to be missing.\n${reason}`);
        });
        (0,_ws__WEBPACK_IMPORTED_MODULE_10__.connect)('ws://localhost:8888/jupyter_apps/echo', true);
        return jupyterApps;
    }
};
...
const TimerView = (0,mobx_react__WEBPACK_IMPORTED_MODULE_2__.observer)(({ timer }) => ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", { onClick: () => timer.reset(), children: ["Jupyter Apps: ", timer.secondsPassed] })));
...
//# sourceMappingURL=lib_index_js.5f3c00e82100aba816c8.js.map