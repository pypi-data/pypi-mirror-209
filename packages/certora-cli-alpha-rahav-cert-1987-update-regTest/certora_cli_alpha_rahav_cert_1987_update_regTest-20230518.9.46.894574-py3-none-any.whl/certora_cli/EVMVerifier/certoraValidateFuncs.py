...
def validate_non_negative_integer(string: str) -> str:
    ...
    :return: The same string, The same string, if the string represents a non-negative  integer
...
def validate_non_negative_integer_or_minus_1(string: str) -> str:
    ...
    :param string: A string
    :return: The same string, The same string, if the string represents a non-negative  integer
    :raises CertoraUserInputError if the string does not represent a a non-negative  integer
    """
    try:
        number = int(string)
