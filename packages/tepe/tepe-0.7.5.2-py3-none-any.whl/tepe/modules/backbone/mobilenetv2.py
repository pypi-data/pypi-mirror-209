...
Ref impl: https://github.com/d-li14/mobilenetv2.pytorch
...
try: # for torchvision<0.4
    from torchvision.models.utils import download_url_to_file, load_state_dict_from_url
except: # for torchvision>=0.4
    from torch.hub import download_url_to_file, load_state_dict_from_url
import torch.nn.functional as F
import math
from ...utils.general import ROOT
...
pretrained_model = {
    'mobilenet_v2': {
        ...
        'file': str(ROOT) + '/asserts/pretrained/mobilenet_v2.pth'
        },
}
...
def mobilenet_v2(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        file, url = pretrained_model['mobilenet_v2']['file'], pretrained_model['mobilenet_v2']['url']
