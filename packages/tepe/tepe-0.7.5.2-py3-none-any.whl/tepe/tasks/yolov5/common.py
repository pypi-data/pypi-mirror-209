...
from .utils.general import colorstr, make_divisible, non_max_suppression, scale_coords, xyxy2xywh
...
class NMS_TRT_function(torch.autograd.Function):
    """
    Just export NMS onnx symbol and forward function is not implemented.
    """
...
class NMS_TRT(nn.Module):
    ...
    def forward(self, x):
        ...
        num_det, det_boxes, det_scores, det_classes = NMS_TRT_function.apply(box, score, self.background_class, self.box_coding,
...
class End2End(nn.Module):
    ...
    def __init__(self, model, max_obj=100, iou_thres=0.45, score_thres=0.25, device=None):
        ...
        self.end2end = NMS_TRT(max_obj, iou_thres, score_thres, device)
        self.end2end.eval()
