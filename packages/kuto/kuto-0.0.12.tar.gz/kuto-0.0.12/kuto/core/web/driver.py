...
class PlayWrightDriver:
    ...
    def __init__(self, browserName: str, headless: bool, state: dict = None):
        ...
        if browserName == 'firefox':
            self.browser = self.playwright.firefox.launch(headless=headless, args=["--start-maximized"])
        elif browserName == 'webkit':
            self.browser = self.playwright.webkit.launch(headless=headless, args=["--start-maximized"])
        else:
    ...
    def switch_tab(self, locator: Locator):
