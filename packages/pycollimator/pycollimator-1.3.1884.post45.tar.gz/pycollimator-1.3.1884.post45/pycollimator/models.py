...
class Model:
    ...
    def __init__(self, data):
        ...
        self._datasource_data_by_name_path: T.Dict[str, pd.DataFrame] = {}  # submodel.block.path -> data (pd.DataFrame)
        self._hashed_files_by_name_path: T.Dict[
            str, SimulationHashedFile
        ] = {}  # submodel.block.path -> SimulationHashedFile
        self.path_data_by_named_path: T.Dict[str, BlockPath] = {}  # submodel.block.path -> BlockPath
    ...
    @property
    def url(self) -> str:
        return f"{GlobalVariables.url()}/projects/{self.project_uuid}/models/{self.uuid}"
