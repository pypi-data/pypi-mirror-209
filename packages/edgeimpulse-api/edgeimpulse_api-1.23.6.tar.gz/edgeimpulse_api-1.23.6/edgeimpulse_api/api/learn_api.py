...
class LearnApi(object):
    ...
    @validate_arguments
    def get_anomaly(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], learn_id : Annotated[StrictInt, Field(..., description="Learn Block ID, use the impulse functions to retrieve the ID")], **kwargs) -> AnomalyResponse:  # noqa: E501
        """Anomaly information
    ...
    def _get_anomaly_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], learn_id : Annotated[StrictInt, Field(..., description="Learn Block ID, use the impulse functions to retrieve the ID")], **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AnomalyResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def get_pretrained_model_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> GetPretrainedModelResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_pretrained_model_info_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_pretrained_model_info_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Get pretrained model 
    ...
    @validate_arguments
    def profile_pretrained_model(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> StartJobResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._profile_pretrained_model_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _profile_pretrained_model_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Profile pretrained model 
    ...
    @validate_arguments
    def save_pretrained_model_parameters(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], save_pretrained_model_request : Optional[SavePretrainedModelRequest] = None, **kwargs) -> GenericApiResponse:  # noqa: E501
        ...
        :param project_id: Project ID (required)
        :type project_id: int
        :param save_pretrained_model_request:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._save_pretrained_model_parameters_with_http_info(project_id, save_pretrained_model_request, **kwargs)  # noqa: E501

    @validate_arguments
    def _save_pretrained_model_parameters_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], save_pretrained_model_request : Optional[SavePretrainedModelRequest] = None, **kwargs):  # noqa: E501
        """Save parameters for pretrained model 
    ...
    @validate_arguments
    def upload_keras_files(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], learn_id : Annotated[StrictInt, Field(..., description="Learn Block ID, use the impulse functions to retrieve the ID")], zip : StrictStr, **kwargs) -> GenericApiResponse:  # noqa: E501
        """Upload Keras files
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._upload_keras_files_with_http_info(project_id, learn_id, zip, **kwargs)  # noqa: E501

    @validate_arguments
    def _upload_keras_files_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], learn_id : Annotated[StrictInt, Field(..., description="Learn Block ID, use the impulse functions to retrieve the ID")], zip : StrictStr, **kwargs):  # noqa: E501
        """Upload Keras files 
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_keras_files" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def upload_pretrained_model(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], model_file : StrictStr, model_file_name : StrictStr, model_file_type : StrictStr, representative_features : Optional[StrictStr] = None, device : Annotated[Optional[StrictStr], Field(description="MCU used for calculating latency, query `latencyDevices` in `listProject` for a list of supported devices (and use the \\\"mcu\\\" property here). If this is kept empty then we'll show an overview of multiple devices.")] = None, **kwargs) -> StartJobResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._upload_pretrained_model_with_http_info(project_id, model_file, model_file_name, model_file_type, representative_features, device, **kwargs)  # noqa: E501
