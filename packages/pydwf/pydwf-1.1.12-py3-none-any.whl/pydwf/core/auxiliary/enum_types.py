...
class DwfEnumFilter(_FixReprMethod, enum.Flag):
    ...
    EExplorer = 1
    """Enumerate Electronics Explorer devices.

    Warning:

        This value is *obsolete*. Use device ID instead.
    """

    Discovery = 2
    """Enumerate Analog Discovery devices.
    ...
    Discovery2 = 3
    """Enumerate Analog Discovery 2 devices.
    ...
    DDiscovery = 4
    """Enumerate Digital Discovery devices.
...
class DwfAcquisitionMode(_FixReprMethod, enum.Enum):
    ...
    Note:
        The difference with the :py:attr:`Record` mode is unclear.
    """
