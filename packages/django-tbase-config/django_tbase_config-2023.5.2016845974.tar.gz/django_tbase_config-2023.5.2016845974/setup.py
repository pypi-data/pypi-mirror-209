...
name = 'django_tbase_config'  # 修改包名字-
version = f'{year}.{month}.{day}' + str(time.time())[:8]
description = 'Terry django base config ,'
author = 'Terry Chan'
author_email = 'napoler2008@gmail.com'
url = 'https://terrychanorg.jetbrains.space/p/django-expand/repositories/tbase_config/files/README.md'
