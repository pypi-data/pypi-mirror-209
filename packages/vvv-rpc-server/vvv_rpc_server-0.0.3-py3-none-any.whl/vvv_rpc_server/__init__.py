...
def get_v_path_info():
    ...
    return v_chrome_file, v_chrome_main_file, v_chrome_exec_path, v_chrome_target, v_chrome_exec, v_chrome_update

def install():
    v_chrome_file, v_chrome_main_file, v_chrome_exec_path, v_chrome_target, v_chrome_exec, v_chrome_update = get_v_path_info()
...
def save_config(data):
    v_chrome_file, v_chrome_main_file, v_chrome_exec_path, v_chrome_target, v_chrome_exec, v_chrome_update = get_v_path_info()
    configpath = os.path.join(v_chrome_update, 'config.cfg')
