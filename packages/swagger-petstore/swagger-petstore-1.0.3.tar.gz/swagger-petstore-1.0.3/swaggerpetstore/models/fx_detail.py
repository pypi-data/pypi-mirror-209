...
class FXDetail(object):
    ...
    def from_dictionary(cls,
        ...
        buy_amount = MonetaryValue.from_dictionary(dictionary.get('buyAmount')) if dictionary.get('buyAmount') else None
        fx_rate = FXRate.from_dictionary(dictionary.get('fxRate')) if dictionary.get('fxRate') else None
        sell_amount = MonetaryValue.from_dictionary(dictionary.get('sellAmount')) if dictionary.get('sellAmount') else None
