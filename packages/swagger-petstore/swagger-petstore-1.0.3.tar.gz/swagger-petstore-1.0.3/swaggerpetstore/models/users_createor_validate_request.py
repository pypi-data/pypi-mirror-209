...
class UsersCreateorValidateRequest(object):

    """Implementation of the 'UsersCreateorValidateRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UsersCreateorValidateRequest class"""
    ...
    def from_dictionary(cls,
        ...
        user_id = UserIDMerchant.from_dictionary(dictionary.get('userID')) if 'userID' in dictionary.keys() else APIHelper.SKIP
