...
class IndividualName(object):
    ...
    *Example4 - single names, such as in Indonesia*
    ...
    def from_dictionary(cls,
        ...
        family_name = dictionary.get("familyName") if dictionary.get("familyName") else None
        given_names = dictionary.get("givenNames") if dictionary.get("givenNames") else None
