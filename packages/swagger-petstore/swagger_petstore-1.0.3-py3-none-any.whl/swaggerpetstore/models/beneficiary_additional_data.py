...
class BeneficiaryAdditionalData(object):
    ...
    value are required if adding additional data.

    Attributes:
        additional_data_key (string): The length of the additionalDataKey
            field is currently restricted to 50 bytes.
        additional_data_value (string): The length of the additionalDataValue
            field is currently restricted to 1024.
    ...
    def from_dictionary(cls,
        ...
        additional_data_key = dictionary.get("additionalDataKey") if dictionary.get("additionalDataKey") else None
        additional_data_value = dictionary.get("additionalDataValue") if dictionary.get("additionalDataValue") else None
