...
class BeneficiaryBankAccountGetResponse(object):

    """Implementation of the 'BeneficiaryBankAccountGetResponse' model.

    This type provides all the possible information required to identify a
    ...
    Attributes:
        ...
        country_code (string): Valid supported ISO 3166 2-character country
            code. It is the territory in which this bank account is
            domiciled.
        ...
        is_active (bool): Return true if the bank account is active
    ...
    def __init__(self,
        ...
        """Constructor for the BeneficiaryBankAccountGetResponse class"""
