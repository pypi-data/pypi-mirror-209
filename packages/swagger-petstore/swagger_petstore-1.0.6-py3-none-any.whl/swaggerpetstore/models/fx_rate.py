...
class FXRate(object):
    ...
    Attributes:
        buy_currency (string): Valid supported ISO 4217 3-character currency
            code.
        rate (float): It is the exchange rate at which the buy currency is
            exchanged into the sell currency. In other words it is the
            buyCurrency:SellCurrency conversation ratio.
    ...
    def from_dictionary(cls,
        ...
        buy_currency = dictionary.get("buyCurrency") if dictionary.get("buyCurrency") else None
