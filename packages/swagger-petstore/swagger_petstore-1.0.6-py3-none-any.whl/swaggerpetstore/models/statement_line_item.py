...
class StatementLineItem(object):
    ...
    Attributes:
        ...
        balance (float): Decimal amount value. The number of decimal places is
    ...
    def from_dictionary(cls,
        ...
        transaction = FinancialTransaction.from_dictionary(dictionary.get('transaction')) if dictionary.get('transaction') else None
