...
import verizon5gmecvnspapi.exceptions.api_exception


class EdgeServiceOnboardingResultErrorException(verizon5gmecvnspapi.exceptions.api_exception.APIException):
