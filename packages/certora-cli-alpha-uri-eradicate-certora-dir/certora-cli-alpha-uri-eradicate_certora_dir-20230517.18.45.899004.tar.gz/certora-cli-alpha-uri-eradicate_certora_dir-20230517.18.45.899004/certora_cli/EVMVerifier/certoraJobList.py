...
from Shared.certoraUtils import get_bin_directory, read_json_file, remove_file, \
...
class JobList:
    ...
    def __init__(self, current_path: Path = Path.cwd()):
        ...
        self.recent_jobs_path = get_bin_directory() / RECENT_JOBS_FILE
        self.temp_file_path = get_bin_directory() / f".tmp{RECENT_JOBS_FILE}"
    ...
    def rename_recent_jobs_file(self) -> None:
        ...
        name = get_bin_directory() / f".incompatible.{current_time}{RECENT_JOBS_FILE}"
        try:
