...
BioSAK iTOL -Labels -ll new_Mag_name.txt -out Mag_name_iTOL_Labels.txt
BioSAK iTOL -Binary -lm Binary_matrix.txt -lt Presence_Absence -gc lightblue -out Presence_Absence_iTOL.txt 
BioSAK iTOL -Binary -lm Binary_matrix.txt -lt Presence_Absence -gc "#85C1E9" -out Presence_Absence_iTOL.txt 
