...
@LastEditTime: 2023-05-22 14:28:49
...
class TaskBaseModel(FrameBaseModel):
    ...
    def add_gear_task_count(self, app_id, act_id, module_id, user_id, open_id, task_type, value):
        """
    ...
    def convert_gear_task_result(self, act_id, module_id, user_id, task_info_dict, config_json, task_count_list):
        ...
        if module_id:
            ...
            params.append(module_id)
        task_gear_count_dict = task_gear_count_model.get_dict(condition_where.to_string(),params=params)
        result["current"] = task_gear_count_dict["now_count"] if task_gear_count_dict else 0  # 当前总累计值
    ...
    def get_client_task_list_v2(self, app_id, act_id, module_id, user_id, task_types="", daily_repeat_browse=False):
        ...
        for task_info_dict in task_info_list:
            ...
            #有子任务列表的相关累计任务
                ...
                result_list.append(self.convert_gear_task_result(act_id,module_id,user_id,task_info_dict,config_json,task_count_list))
