...
@LastEditTime: 2023-05-22 16:10:10
...
class TaskBaseModel(FrameBaseModel):
    ...
    def convert_gear_task_result(self, act_id, module_id, user_id, task_info_dict, config_json, task_count_list):
        ...
        if module_id:
            ...
            params.append(module_id)
        task_gear_count_dict = task_gear_count_model.get_dict(condition_where.to_string(),"sum(now_count) as now_count",params=params)
