...
@LastEditTime: 2023-05-23 10:30:00
...
class TaskType(Enum):
    ...
    # 抽盒/抽包/抽奖，格式：{"reward_value":0,"limit_num":0,"asset_object_id":""}  字段说明：reward_value:奖励值 satisfy_num:满足数（当大于1时才需要配置字段） limit_num:完成限制数 asset_object_id:资产对象标识
    lottery = 20
