...
class Unit(Enum):
    ELEMENTS = {b'\x01': config["values.enum"]["time_year"],
                b'\x02': config["values.enum"]["time_month"],
                b'\x03': config["values.enum"]["time_week"],
                b'\x04': config["values.enum"]["time_day"],
                b'\x05': config["values.enum"]["time_hour"],
                b'\x06': config["values.enum"]["time_minute"],
                b'\x07': config["values.enum"]["time_second"],
                b'\x08': config["values.enum"]["phase_angle_degree"],
                b'\x09': config["values.enum"]["temperature"],
                b'\x0a': config["values.enum"]["local_currency"],
                b'\x0b': config["values.enum"]["length_metre"],
                b'\x0c': config["values.enum"]["speed_metre_per_second"],
                b'\x0d': config["values.enum"]["volume_value_cubic_metre"],
                b'\x0e': config["values.enum"]["corrected_volume_cubic_metre"],
                b'\x0f': config["values.enum"]["volume_flux_cubic_metre_per_hour"],
                b'\x10': config["values.enum"]["corrected_volume_flux_cubic_metre_per_hour"],
                b'\x11': config["values.enum"]["volume_flux_cubic_metre_per_day"],
                b'\x12': config["values.enum"]["corrected_volume_flux_cubic_metre_per_day"],
                b'\x13': config["values.enum"]["volume_litre"],
                b'\x14': config["values.enum"]["mass_kilogram"],
                b'\x15': config["values.enum"]["force_newton"],
                b'\x16': config["values.enum"]["energy_newton_meter"],
                b'\x17': config["values.enum"]["pressure_pascal"],
                b'\x18': config["values.enum"]["pressure_bar"],
                b'\x19': config["values.enum"]["energy_joule"],
                b'\x1a': config["values.enum"]["thermal_power_rate_of_change_joule_per_hour"],
                b'\x1b': config["values.enum"]["active_power_watt"],
                b'\x1c': config["values.enum"]["apparent_power_volt_ampere"],
                b'\x1d': config["values.enum"]["reactive_power_var"],
                b'\x1e': config["values.enum"]["active_energy_value_watt_hour"],
                b'\x1f': config["values.enum"]["apparent_energy_value_volt_ampere_hour"],
                b'\x20': config["values.enum"]["reactive_energy_value_var_hour"],
                b'\x21': config["values.enum"]["current_ampere"],
                b'\x22': config["values.enum"]["electrical_charge_coulomb"],
                b'\x23': config["values.enum"]["voltage_volt"],
                b'\x24': config["values.enum"]["electric_field_strength_volt_per_metre"],
                b'\x25': config["values.enum"]["capacitance_farad"],
                b'\x26': config["values.enum"]["resistance_ohm"],
                b'\x27': config["values.enum"]["resistivity"],
                b'\x28': config["values.enum"]["magnetic_flux_weber"],
                b'\x29': config["values.enum"]["magnetic_flux_density_tesla"],
                b'\x2a': config["values.enum"]["magnetic_field_strength_ampere_per_metre"],
                b'\x2b': config["values.enum"]["inductance_henry"],
                b'\x2c': config["values.enum"]["frequency_hertz"],
                b'\x2d': config["values.enum"]["rw_active_energy_value"],
                b'\x2e': config["values.enum"]["rb_reactive_energy_value"],
                b'\x2f': config["values.enum"]["rs_apparent_energy_value"],
                b'\x30': config["values.enum"]["volt_squared_hour_volt_squared_hour_meter"],
                b'\x31': config["values.enum"]["ampere_squared_hour"],
                b'\x32': config["values.enum"]["mass_flux_kilogram_per_second"],
                b'\x33': config["values.enum"]["conductance_siemens"],
                b'\x34': config["values.enum"]["temperature_kelvin"],
                b'\x35': config["values.enum"]["ru2h_volt_squared_hour_meter"],
                b'\x36': config["values.enum"]["ri2h_ampere_squared_hour_meter"],
                b'\x37': config["values.enum"]["rv_meter"],
                b'\x38': config["values.enum"]["percentage"],
                b'\x39': config["values.enum"]["ampere_hours"],
                b'\x3a': config["values.common"]["reserved"],
                b'\x3b': config["values.common"]["reserved"],
                b'\x3c': config["values.enum"]["energy_per_volume"],
                b'\x3d': config["values.enum"]["calorific_value_wobbe"],
                b'\x3e': config["values.enum"]["molar_fraction_of_gas_composition_mole_percent"],
                b'\x3f': config["values.enum"]["mass_density_quantity_of_material"],
                b'\x40': config["values.enum"]["dynamic_viscosity_pascal_second"],
                b'\x41': config["values.enum"]["specific_energy_joule_kilogram"],
                b'\x42': config["values.enum"]["pressure_gram_per_square_centimeter"],
                b'\x43': config["values.enum"]["pressure_atmosphere"],
                b'\x46': config["values.enum"]["signal_strength_milliwatt"],
                b'\x47': config["values.enum"]["signal_strength_microvolt"],
                b'\x48': config["values.enum"]["logarithmic_unit"],
                b'\x49': config["values.common"]["reserved"],
                b'\x4a': config["values.common"]["reserved"],
                b'\x4b': config["values.common"]["reserved"],
                b'\x4c': config["values.common"]["reserved"],
                b'\x4d': config["values.common"]["reserved"],
                b'\x4e': config["values.common"]["reserved"],
                b'\x4f': config["values.common"]["reserved"],
                b'\x50': config["values.common"]["reserved"],
                b'\x51': config["values.common"]["reserved"],
                b'\x52': config["values.common"]["reserved"],
                b'\x53': config["values.common"]["reserved"],
                b'\x54': config["values.common"]["reserved"],
                b'\x55': config["values.common"]["reserved"],
                b'\x56': config["values.common"]["reserved"],
                b'\x57': config["values.common"]["reserved"],
                b'\x58': config["values.common"]["reserved"],
                b'\x59': config["values.common"]["reserved"],
                b'\x5a': config["values.common"]["reserved"],
                b'\x5b': config["values.common"]["reserved"],
                b'\x5c': config["values.common"]["reserved"],
                b'\x5d': config["values.common"]["reserved"],
                b'\x5e': config["values.common"]["reserved"],
                b'\x5f': config["values.common"]["reserved"],
                b'\x60': config["values.common"]["reserved"],
                b'\x61': config["values.common"]["reserved"],
                b'\x62': config["values.common"]["reserved"],
                b'\x63': config["values.common"]["reserved"],
                b'\x64': config["values.common"]["reserved"],
                b'\x65': config["values.common"]["reserved"],
                b'\x66': config["values.common"]["reserved"],
                b'\x67': config["values.common"]["reserved"],
                b'\x68': config["values.common"]["reserved"],
                b'\x69': config["values.common"]["reserved"],
                b'\x6a': config["values.common"]["reserved"],
                b'\x6b': config["values.common"]["reserved"],
                b'\x6c': config["values.common"]["reserved"],
                b'\x6d': config["values.common"]["reserved"],
                b'\x6e': config["values.common"]["reserved"],
                b'\x6f': config["values.common"]["reserved"],
                b'\x70': config["values.common"]["reserved"],
                b'\x71': config["values.common"]["reserved"],
                b'\x72': config["values.common"]["reserved"],
                b'\x73': config["values.common"]["reserved"],
                b'\x74': config["values.common"]["reserved"],
                b'\x75': config["values.common"]["reserved"],
                b'\x76': config["values.common"]["reserved"],
                b'\x77': config["values.common"]["reserved"],
                b'\x78': config["values.common"]["reserved"],
                b'\x79': config["values.common"]["reserved"],
                b'\x7a': config["values.common"]["reserved"],
                b'\x7b': config["values.common"]["reserved"],
                b'\x7c': config["values.common"]["reserved"],
                b'\x7d': config["values.common"]["reserved"],
                b'\x7e': config["values.common"]["reserved"],
                b'\x7f': config["values.common"]["reserved"],
                b'\x80': config["values.enum"]["length_inch"],
                b'\x81': config["values.enum"]["length_foot"],
                b'\x82': config["values.enum"]["mass_pound"],
                b'\x83': config["values.enum"]["temperature_fahrenheit"],
                b'\x84': config["values.enum"]["temperature_rankine"],
                b'\x85': config["values.enum"]["area_square_inch"],
                b'\x86': config["values.enum"]["area_square_foot"],
                b'\x87': config["values.enum"]["area_acre"],
                b'\x88': config["values.enum"]["volume_cubic_inch"],
                b'\x89': config["values.enum"]["volume_cubic_foot"],
                b'\x8a': config["values.enum"]["volume_acre_foot"],
                b'\x8b': config["values.enum"]["volume_gallon_imperial"],
                b'\x8c': config["values.enum"]["volume_gallon_us"],
                b'\x8d': config["values.enum"]["force_pound_force"],
                b'\x8e': config["values.enum"]["pressure_pound_force_per_square_inch"],
                b'\x8f': config["values.enum"]["density_pound_per_cubic_foot"],
                b'\x90': config["values.enum"]["dynamic_viscosity"],
                b'\x91': config["values.enum"]["kinematic_viscosity_square_foot_per_second"],
                b'\x92': config["values.enum"]["energy_british_thermal_unit"],
                b'\x93': config["values.enum"]["energy_therm_eu"],
                b'\x94': config["values.enum"]["energy_therm_us"],
                b'\x95': config["values.enum"]["calorific_value_of_mass_lenthalpy"],
                b'\x96': config["values.enum"]["calorific_value_wobbe"],
                b'\x97': config["values.enum"]["volume_meter_cubic_feet_rv"],
                b'\x98': config["values.enum"]["speed_foot_per_second"],
                b'\x99': config["values.enum"]["volume_flux_cubic_foot_per_second"],
                b'\x9a': config["values.enum"]["volume_flux_cubic_foot_per_min"],
                b'\x9b': config["values.enum"]["volume_flux_cubic_foot_per_hour"],
                b'\x9c': config["values.enum"]["volume_flux_cubic_foot_per_day"],
                b'\x9d': config["values.enum"]["volume_flux_acre_foot_per_second"],
                b'\x9e': config["values.enum"]["volume_flux_acre_foot_per_min"],
                b'\x9f': config["values.enum"]["volume_flux_acre_foot_per_hour"],
                b'\xa0': config["values.enum"]["volume_flux_acre_foot_per_day"],
                b'\xa1': config["values.enum"]["volume_imperial_gallon_meter_rv"],
                b'\xa2': config["values.enum"]["volume_flux_imperial_gallon_per_second"],
                b'\xa3': config["values.enum"]["volume_flux_imperial_gallon_per_min"],
                b'\xa4': config["values.enum"]["volume_flux_imperial_gallon_per_hour"],
                b'\xa5': config["values.enum"]["volume_flux_imperial_gallon_per_day"],
                b'\xa6': config["values.enum"]["volume_us_gallon_rv"],
                b'\xa7': config["values.enum"]["volume_flux_us_gallon_per_second"],
                b'\xa8': config["values.enum"]["volume_flux_us_gallon_per_min"],
                b'\xa9': config["values.enum"]["volume_flux_us_gallon_per_hour"],
                b'\xaa': config["values.enum"]["volume_flux_us_gallon_per_day"],
                b'\xab': config["values.enum"]["energy_flow_british_thermal_unit_per_second"],
                b'\xac': config["values.enum"]["energy_flow_british_thermal_unit_per_minute"],
                b'\xad': config["values.enum"]["energy_flow_british_thermal_unit_per_hour"],
                b'\xae': config["values.enum"]["energy_flow_british_thermal_unit_per_day"],
                b'\xaf': config["values.common"]["reserved"],
                b'\xb0': config["values.common"]["reserved"],
                b'\xb1': config["values.common"]["reserved"],
                b'\xb2': config["values.common"]["reserved"],
                b'\xb3': config["values.common"]["reserved"],
                b'\xb4': config["values.common"]["reserved"],
                b'\xb5': config["values.common"]["reserved"],
                b'\xb6': config["values.common"]["reserved"],
                b'\xb7': config["values.common"]["reserved"],
                b'\xb8': config["values.common"]["reserved"],
                b'\xb9': config["values.common"]["reserved"],
                b'\xba': config["values.common"]["reserved"],
                b'\xbb': config["values.common"]["reserved"],
                b'\xbc': config["values.common"]["reserved"],
                b'\xbd': config["values.common"]["reserved"],
                b'\xbe': config["values.common"]["reserved"],
                b'\xbf': config["values.common"]["reserved"],
                b'\xc0': config["values.common"]["reserved"],
                b'\xc1': config["values.common"]["reserved"],
                b'\xc2': config["values.common"]["reserved"],
                b'\xc3': config["values.common"]["reserved"],
                b'\xc4': config["values.common"]["reserved"],
                b'\xc5': config["values.common"]["reserved"],
                b'\xc6': config["values.common"]["reserved"],
                b'\xc7': config["values.common"]["reserved"],
                b'\xc8': config["values.common"]["reserved"],
                b'\xc9': config["values.common"]["reserved"],
                b'\xca': config["values.common"]["reserved"],
                b'\xcb': config["values.common"]["reserved"],
                b'\xcc': config["values.common"]["reserved"],
                b'\xcd': config["values.common"]["reserved"],
                b'\xce': config["values.common"]["reserved"],
                b'\xcf': config["values.common"]["reserved"],
                b'\xd0': config["values.common"]["reserved"],
                b'\xd1': config["values.common"]["reserved"],
                b'\xd2': config["values.common"]["reserved"],
                b'\xd3': config["values.common"]["reserved"],
                b'\xd4': config["values.common"]["reserved"],
                b'\xd5': config["values.common"]["reserved"],
                b'\xd6': config["values.common"]["reserved"],
                b'\xd7': config["values.common"]["reserved"],
                b'\xd8': config["values.common"]["reserved"],
                b'\xd9': config["values.common"]["reserved"],
                b'\xda': config["values.common"]["reserved"],
                b'\xdb': config["values.common"]["reserved"],
                b'\xdc': config["values.common"]["reserved"],
                b'\xdd': config["values.common"]["reserved"],
                b'\xde': config["values.common"]["reserved"],
                b'\xdf': config["values.common"]["reserved"],
                b'\xe0': config["values.common"]["reserved"],
                b'\xe1': config["values.common"]["reserved"],
                b'\xe2': config["values.common"]["reserved"],
                b'\xe3': config["values.common"]["reserved"],
                b'\xe4': config["values.common"]["reserved"],
                b'\xe5': config["values.common"]["reserved"],
                b'\xe6': config["values.common"]["reserved"],
                b'\xe7': config["values.common"]["reserved"],
                b'\xe8': config["values.common"]["reserved"],
                b'\xe9': config["values.common"]["reserved"],
                b'\xea': config["values.common"]["reserved"],
                b'\xeb': config["values.common"]["reserved"],
                b'\xec': config["values.common"]["reserved"],
                b'\xed': config["values.common"]["reserved"],
                b'\xee': config["values.common"]["reserved"],
                b'\xef': config["values.common"]["reserved"],
                b'\xf0': config["values.common"]["reserved"],
                b'\xf1': config["values.common"]["reserved"],
                b'\xf2': config["values.common"]["reserved"],
                b'\xf3': config["values.common"]["reserved"],
                b'\xf4': config["values.common"]["reserved"],
                b'\xf5': config["values.common"]["reserved"],
                b'\xf6': config["values.common"]["reserved"],
                b'\xf7': config["values.common"]["reserved"],
                b'\xf8': config["values.common"]["reserved"],
                b'\xf9': config["values.common"]["reserved"],
                b'\xfa': config["values.common"]["reserved"],
                b'\xfb': config["values.common"]["reserved"],
                b'\xfc': config["values.common"]["reserved"],
                b'\xfd': config["values.enum"]["extended_table_of_units"],
                b'\xfe': config["values.enum"]["other_unit"],
                b'\xff': config["values.enum"]["no_unit_unitless_count"]}
    ...
    def __str__(self):
        match self.get_scaler():
            case 3: return config["values.prefix"]["kilo"] + super(Unit, self).__str__()
