...
For this step of the tutorial, launch the metalib using '$ metalib' and create a metagraph of your choice and save it under the name you want.""")
...
For now, you can use '$ toast <your BAGUETTE folder> --pattern '{chosen_metagraph}' --paint red'.
...
def copy_reports():
    ...
    parser = argparse.ArgumentParser("Report Examples", description="This script will copy report examples (BAGUETTE input files) to the given destination folder.")
    ...
    extract_subfolder(reports_dir, pth)
