...
class Setting(Generic[T]):
    ...
    def __new__(cls, default : T) -> Self:
    ...
    def specialize_subclass(self, cls : type) -> Self:
        """
...
del abstractmethod, Any, Generic, Self, TypeVar, Color, hybridmethod, staticproperty        # type: ignore