...
class SecretKeysPaginatedResponse(pydantic.BaseModel):
    ...
    results: typing.Optional[typing.List[SecretKeys]] = pydantic.Field(description=("Array of secret keys objects.\n"))
