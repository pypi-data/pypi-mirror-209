...
class CreatePaymentLinkPse(pydantic.BaseModel):
    amount: CreatePaymentLinkPseAmount = pydantic.Field(
        description=(
    ...
    allowed_payment_method_types: typing.Optional[typing.List[EnumPaymentLinkAllowedPaymentMethod]] = pydantic.Field(
        description=(
