...
class TaxReturnBusinessMonthly(pydantic.BaseModel):
    ...
    determinacion_isr: typing.Optional[typing.Dict[str, typing.Any]] = pydantic.Field(
        description=("Information used to calculate the provisional income tax for the period.\n")
    )
    detalle_pago_isr: typing.Optional[typing.Dict[str, typing.Any]] = pydantic.Field(
        description=("Information on the monthly provisional payments for the income tax.\n")
    )
    determinacion_iva: typing.Optional[typing.Dict[str, typing.Any]] = pydantic.Field(
        description=("Information used to calculate the provisional VAT tax for the period.\n")
    )
    detalle_pago_iva: typing.Optional[typing.Dict[str, typing.Any]] = pydantic.Field(
