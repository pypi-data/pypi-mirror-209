...
class BalancesClient:
    ...
    def list_balances(
        ...
        *,
        ...
        balance_lt: typing.Optional[str] = None,
        balance_lte: typing.Optional[str] = None,
        balance_gt: typing.Optional[str] = None,
        balance_gte: typing.Optional[str] = None,
        balance_range: typing.Optional[str] = None,
        ...
        _response = httpx.request(
            ...
            params={
                ...
                "account__type__in": account_type_in,
                "balance": balance,
                "balance__lt": balance_lt,
                "balance__lte": balance_lte,
                "balance__gt": balance_gt,
                "balance__gte": balance_gte,
                "balance__range": balance_range,
                "currency": currency,
