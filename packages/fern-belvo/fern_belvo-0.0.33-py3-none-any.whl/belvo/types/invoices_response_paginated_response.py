...
class InvoicesResponsePaginatedResponse(pydantic.BaseModel):
    ...
    results: typing.Optional[typing.List[InvoicesResponsePaginatedResponseResultsItem]] = pydantic.Field(
