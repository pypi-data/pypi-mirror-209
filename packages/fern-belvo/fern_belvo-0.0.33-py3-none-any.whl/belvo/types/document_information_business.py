...
class DocumentInformationBusiness(pydantic.BaseModel):
    """
    ...
    form_number: str = pydantic.Field(description=("The institution-provided identifier for the tax declaration.\n"))
