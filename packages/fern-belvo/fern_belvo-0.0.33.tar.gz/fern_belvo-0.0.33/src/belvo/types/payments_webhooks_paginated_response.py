...
class PaymentsWebhooksPaginatedResponse(pydantic.BaseModel):
    ...
    results: typing.Optional[typing.List[PaymentWebhook]] = pydantic.Field(description=("Array of webhook objects.\n"))
