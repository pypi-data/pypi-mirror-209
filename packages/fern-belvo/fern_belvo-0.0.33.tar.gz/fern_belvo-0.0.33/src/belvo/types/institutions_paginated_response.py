...
class InstitutionsPaginatedResponse(pydantic.BaseModel):
    ...
    results: typing.Optional[typing.List[Institution]] = pydantic.Field(description=("Array of institution objects.\n"))
