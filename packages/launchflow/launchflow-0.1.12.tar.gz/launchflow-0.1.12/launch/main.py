...
from launch.jobs import job_commands
from launch.projects import project_commands
from launch.pipelines import pipeline_commands
...
app.add_typer(job_commands.app,
              name='jobs',
              help='Commands for managing LaunchFlow jobs')
app.add_typer(project_commands.app,
              name='projects',
              help='Commands for managing LaunchFlow projects')
app.add_typer(pipeline_commands.app,
              name='pipelines',
              help='Commands for managing LaunchFlow pipelines')
