...
import requests
from sidetrek.cli_commands.constants import NODE_ENV, APP_NAME, GENERATED_LOCAL_SIDETREK_DIRNAME, GENERATED_PROJECT_DIRNAME
...
def get_current_user() -> dict | None:
    try:
        ...
        print(f"current_user_res={current_user_res}")
