...
class SceneDetector():
    ...
    def detect_scene_by_start_end(self, start, end):
        scene_labels = []
        ...
        start = FrameTimecode(timecode=start, fps=fps)
        end = FrameTimecode(timecode=end, fps=fps)
    ...
    def detect_scene(self, time_pos, length):
        ...
        return self.detect_scene_by_start_end(start_time, end_time)
