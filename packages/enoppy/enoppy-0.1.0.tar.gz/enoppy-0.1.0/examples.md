...
any_dim_cec = enoppy.get_cecs(None)
print(any_dim_cec)

# get all the available separable functions accepting 2D
separable_2d_cec = enoppy.get_cecs(
    ndim=2,  # dimension
    separable=True,
)
...
f12005 = enoppy.cec_based.F12005()
print(f12005.evaluate(np.array([5, 4, 5])))      # get results
print(f12005.bounds)
print(f12005.lb)
print(f12005.ub)

# f12005 = enoppy.cec_based.F12005(ndim=1010)
# print(f12005.lb)

lb = [-10, ] * 15
ub = [10, ] * 15
bounds = [lb, ub]
f12005 = enoppy.cec_based.F12005(bounds=bounds)
print(f12005.lb)
...
f22005 = enoppy.cec_based.F22005(ndim=2)
...
enoppy.plot_latex_formula(latex)


## Test read file matrix
f32005 = enoppy.cec_based.F32005(ndim=10)
x = np.ones(10)
print(f32005.evaluate(x))
print(f32005.f_matrix)
print(f32005.x_global)

problem = enoppy.cec_based.F212005(ndim=10)
x = np.ones(10)
...
from enoppy.dimension_based.benchmark2d import Functions        # import 2-d benchmark functions
import numpy as np
...
from enoppy.type_based.multi_modal import Functions             # import 2-d benchmark functions
import numpy as np


## For CEC

from enoppy.cec.cec2014 import Functions                        # import cec2014 functions
import numpy as np
...
import numpy as np
from enoppy.cec.cec2005.F1 import Model as f1
from enoppy.cec.cec2008.F7 import Model as f7
...
import numpy as np
from enoppy.cec.cec2010.function import F1, F2, ..., F12,..
...
import numpy as np
from enoppy.cec.cec2013.unconstraint import Model as M13
from enoppy.cec.cec2014.unconstraint2 import Model as MD2
...
import numpy as np
from enoppy.cec.cec2014.function import F1, F2, ...
from enoppy.cec.cec2014.unconstraint2 import Model as MD2
from enoppy.cec.cec2014.unconstraint import Model as MD
...
## CEC-2015 
import numpy as np
from enoppy.cec.cec2015.function import F1, F2,...
...
## CEC basic 
import numpy as np
from enoppy.cec_basic.cec2014 import *
...
from enoppy.cec.cec2020.constant import benchmark_function as BF
from enoppy.cec.cec2020 import engineering
