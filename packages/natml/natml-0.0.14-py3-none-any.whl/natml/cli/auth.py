...
@app.command(name="login", help="Login to NatML.")
def login (
    access_key: str=Argument(..., help="NatML access key.", envvar="NATML_ACCESS_KEY")
) -> None:
...
@app.command(name="logout", help="Logout from NatML.")
def logout () -> None:
    _set_access_key(None)
    print("Successfully logged out of NatML")
...
def get_access_key () -> str:
    ...
    Returns:
        str: CLI access key.
    """
    credentials_path = Path.home() / ".natml" / "credentials"
