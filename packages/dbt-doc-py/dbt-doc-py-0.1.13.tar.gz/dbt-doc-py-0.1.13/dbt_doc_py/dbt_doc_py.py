...
def mk_column_prompt(node: NodeMetadata, col: ColumnMetadata, documented_nodes: Dict[str, NodeMetadata]) -> str:
    ...
    inherited_docs_str = "\n\n".join(inherited_docs)
    inheritance = f"""This column is inherited from another model. Use this column's documentation from the source model to write the requested one and be sure to mention it alongside the name of the source model. 
    ...
    First, explain the meaning of the column in plain, non-technical English.
...
if __name__ == "__main__":
    ...
    #sys.argv = ['dbt-doc-py', '--working-directory', 'C:\\Users\\Lenin\\Documents\\Development\\TextQL\\projects\\dbt_test']    
    run_async_main()
