...
class StatusUpdateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text, status_type, parent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, text, status_type, parent, *args, **kwargs):  # noqa: E501
        """StatusUpdateRequest - a model defined in OpenAPI
