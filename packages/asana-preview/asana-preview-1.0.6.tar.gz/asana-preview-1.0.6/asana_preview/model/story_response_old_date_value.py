...
class StoryResponseOldDateValue(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StoryResponseOldDateValue - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            start_on (date, none_type): The day on which work for this goal begins, or null if the goal has no start date. This takes a date with `YYYY-MM-DD` format, and cannot be set unless there is an accompanying due date.. [optional]  # noqa: E501
            ...
            due_on (date): The localized day on which this goal is due. This takes a date with format `YYYY-MM-DD`.. [optional]  # noqa: E501
        """
