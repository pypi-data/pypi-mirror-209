...
class ProjectBaseCurrentStatusAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text, color, *args, **kwargs):  # noqa: E501
        """ProjectBaseCurrentStatusAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, text, color, *args, **kwargs):  # noqa: E501
        """ProjectBaseCurrentStatusAllOf - a model defined in OpenAPI
