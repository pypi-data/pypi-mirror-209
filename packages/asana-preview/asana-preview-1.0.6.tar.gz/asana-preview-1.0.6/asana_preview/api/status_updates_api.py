...
class StatusUpdatesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_status_for_object_endpoint = _Endpoint(
            settings={
                'response_type': (GetStatus200Response,),
                'auth': [
                    'personalAccessToken'
                ],
                'endpoint_path': '/status_updates',
                'operation_id': 'create_status_for_object',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'create_status_for_object_request': 'body',
                    'opt_pretty': 'query',
                    'limit': 'query',
                    'offset': 'query',
                    'opt_fields': 'query',
        ...
        self.delete_status_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/status_updates/{status_gid}',
        ...
        self.get_statuses_for_object_endpoint = _Endpoint(
            settings={
                'response_type': (GetStatusesForObject200Response,),
                'auth': [
                    'personalAccessToken'
                ],
                'endpoint_path': '/status_updates',
                'operation_id': 'get_statuses_for_object',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_status_for_object(
        ...
        **kwargs
        ...
        >>> thread = api.create_status_for_object(create_status_for_object_request, async_req=True)
        >>> result = thread.get()

        Args:
            create_status_for_object_request (CreateStatusForObjectRequest): The status update to create.
        ...
        kwargs['create_status_for_object_request'] = \
            create_status_for_object_request
        return self.create_status_for_object_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_status(
        ...
        **kwargs
        ...
        >>> thread = api.delete_status(status_gid, async_req=True)
        >>> result = thread.get()
    ...
    def get_status(
        ...
        **kwargs
        ...
        >>> thread = api.get_status(status_gid, async_req=True)
        >>> result = thread.get()
    ...
    def get_statuses_for_object(
        ...
        **kwargs
        ...
        kwargs['parent'] = \
            parent
        return self.get_statuses_for_object_endpoint.call_with_http_info(**kwargs)
