...
class WebhookRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource, target, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            filters ([WebhookRequestFiltersInner]): An array of WebhookFilter objects to specify a whitelist of filters to apply to events from this webhook. If a webhook event passes any of the filters the event will be delivered; otherwise no event will be sent to the receiving server.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource, target, *args, **kwargs):  # noqa: E501
        """WebhookRequest - a model defined in OpenAPI
