...
class MembershipResponseAnyOf4UserTaskList(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MembershipResponseAnyOf4UserTaskList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): The name of the user task list.. [optional]  # noqa: E501
            owner (bool, date, datetime, dict, float, int, list, str, none_type): The owner of the user task list, i.e. the person whose My Tasks is represented by this resource.. [optional]  # noqa: E501
            workspace (bool, date, datetime, dict, float, int, list, str, none_type): The workspace in which the user task list is located.. [optional]  # noqa: E501
        """
