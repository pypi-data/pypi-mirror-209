...
class GetFinanceScoreResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["finance_score", "request_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["finance_score", "request_id", ], str]):
