...
},{"./dist/worker/index":"DwFB"}],"KBaF":[function(require,module,exports) {
...
},{}],"Slw0":[function(require,module,exports) {
"use strict";
...
async function checkIfBadgeEarned(badges, result, userCode, gameState, currentAvatarID) {
  ...
  const response = await (0, _nodeFetch.default)(serviceUrl, {
    method: "POST",
    headers: {
...
},{"node-fetch":"KBaF"}],"rgp3":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=/static/react/webWorker.c67269a2.js.map