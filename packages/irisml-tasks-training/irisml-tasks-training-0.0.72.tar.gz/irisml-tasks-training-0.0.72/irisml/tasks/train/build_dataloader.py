...
def build_dataloader(dataset, transform, batch_size: int, num_processes: int = 1, shuffle=True, drop_last=True):
    ...
    return torch.utils.data.DataLoader(my_dataset, batch_size=batch_size, num_workers=4, sampler=sampler, drop_last=drop_last,
