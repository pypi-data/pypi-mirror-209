...
class PredictClientTestCase(unittest.TestCase):
   ...
   def test_prediction_direct(self):
       client = PredictClient('http://1225281119574610.cn-beijing.pai-eas.aliyuncs.com', 'aigccommon/controlnet_preprocess')
       client.set_endpoint_type(ENDPOINT_TYPE_DIRECT)
       client.set_token('MzQxZjgxODg1MDUwODFjMzk2MjZkODFiNjU5N2UyY2FlMTBiY2NjYw==')
       client.init()
