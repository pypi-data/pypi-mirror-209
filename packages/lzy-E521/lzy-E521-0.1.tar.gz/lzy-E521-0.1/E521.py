...
class E521:
    def __init__(self, visible=True, **kwargs):
        ...
        self.workbook = self.eobj.Workbooks.Open(kwargs.get('file_path'))
        self.worksheet = self.workbook.ActiveSheet

    def sheet_names(self):
        sheets_count = self.workbook.Sheets.Count
        return [self.workbook.Sheets(i).Name for i in range(1, sheets_count + 1)]
