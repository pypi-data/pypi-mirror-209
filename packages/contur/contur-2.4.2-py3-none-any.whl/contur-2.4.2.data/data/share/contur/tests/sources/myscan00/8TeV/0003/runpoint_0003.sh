...
#$ -o /unix/cedar/pwang/runArea/Regression_Test/myscan00/8TeV/0003/contur.log # Output file path
...
cd /unix/cedar/pwang/runArea/Regression_Test/myscan00/8TeV/0003
