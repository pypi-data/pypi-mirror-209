...
#$ -o /unix/cedar/pwang/runArea/Regression_Test/myscan00/7TeV/0000/contur.log # Output file path
...
cd /unix/cedar/pwang/runArea/Regression_Test/myscan00/7TeV/0000
