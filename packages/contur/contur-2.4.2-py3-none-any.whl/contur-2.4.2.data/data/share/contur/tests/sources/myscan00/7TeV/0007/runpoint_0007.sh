...
#$ -o /unix/cedar/pwang/runArea/Regression_Test/myscan00/7TeV/0007/contur.log # Output file path
...
cd /unix/cedar/pwang/runArea/Regression_Test/myscan00/7TeV/0007
