...
#$ -o /unix/cedar/pwang/runArea/Regression_Test/myscan00/8TeV/0002/contur.log # Output file path
...
cd /unix/cedar/pwang/runArea/Regression_Test/myscan00/8TeV/0002
