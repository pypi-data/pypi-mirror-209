...
class ExergenicsApi:
    ...
    ********************************
    ...
    def plotlyDynamicBowlChart2D(self, data, legendTitle="legendTitle", xAxisTitle="xAxisTitle",
                                 ...
                                 width="width", height="height", fontSize=12, fontFamily="TimesNewRoman",
                                 fontColor="black",
                                 legendFamily="Courier", legendSize=12, legendColor="black", legendBg="LightSteelBlue",
                                 titleFont="Arial", titleColor="black"):
    ...
    def portalChart_dynamicBowlChart2D(self, plantCode, chartName, portalCategory, data,
        ...
        urlToChart = self.plotlyDynamicBowlChart2D(data, legendTitle, xAxisTitle, yAxisTitle, yAxis2Title,
                                                   outputType, backgroundColor, width, height, fontSize,
                                                   fontFamily,
    ...
    def plotlyDynamicBarChart2D(self, data, legendTitle="legendTitle", xAxisTitle="xAxisTitle",
                                ...
                                width="width", height="height", fontSize=16, fontFamily="Verdana", fontColor="black",
    ...
    def portalChart_dynamicBarChart2D(self, plantCode, chartName, portalCategory, data,
                                      legendTitle="legendTitle", xAxisTitle="xAxisTitle", yAxisTitle="yAxisTitle",
                                      outputType="html", backgroundColor="white", width="width", height="height",
    ...
    def portalChart_generalised3D(self, plantCode, chartName, portalCategory, dataJSON,
                                      xAxisTitle="xAxisTitle", yAxisTitle="yAxisTitle", zAxisTitle="zAxisTitle",
                                      fileName="fileName", markerSize="markerSize", backgroundColor="white", width="width",
                                      height="height", fontSize=12, fontFamily="Verdana",
                                      fontColor="black", legendPosition="legendPosition", legendFamily="Verdana", legendSize=12, legendColor="black",
        ...
        urlToChart = self.plotlyGeneralised3D(dataJSON, xAxisTitle, yAxisTitle, zAxisTitle, fileName, markerSize,
                                                  backgroundColor, width, height, fontSize, fontFamily, fontColor,
                                                  legendPosition, legendFamily, legendSize, legendColor, legendBg)
        self.putFile(plantCode, urlToChart, portalCategory,
                     chartName, equipCode, jobId)
        return urlToChart

    def plotlyGeneralised3D(self, dataJSON, xAxisTitle="xAxisTitle", yAxisTitle="yAxisTitle", zAxisTitle="zAxisTitle",
                                fileName="fileName", markerSize="markserSize", backgroundColor="white", width="width",
                                height="height", fontSize=12, fontFamily="Verdana",
                                fontColor="black", legendPosition="legendPosition", legendFamily="Verdana", legendSize=12, legendColor="black",
