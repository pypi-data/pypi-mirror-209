...
class Data(google.protobuf.message.Message):
    ...
    @property
    def dc_battery(self) -> frequenz.api.microgrid.common_pb2.DC:
        """DC metrics for the inverter-battery linkage.
        This is applicable to `BATTERY` and `HYBRID` inverters only.
        """
    @property
    def dc_solar(self) -> frequenz.api.microgrid.common_pb2.DC:
    ...
    def __init__(
        self,
        *,
        dc_battery: frequenz.api.microgrid.common_pb2.DC | None = ...,
        dc_solar: frequenz.api.microgrid.common_pb2.DC | None = ...,
        ac: frequenz.api.microgrid.common_pb2.AC | None = ...,
        temperature: frequenz.api.microgrid.common_pb2.Metric | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["ac", b"ac", "dc_battery", b"dc_battery", "dc_solar", b"dc_solar", "temperature", b"temperature"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ac", b"ac", "dc_battery", b"dc_battery", "dc_solar", b"dc_solar", "temperature", b"temperature"]) -> None: ...
