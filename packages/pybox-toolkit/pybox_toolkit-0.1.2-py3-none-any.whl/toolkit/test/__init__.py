...
class ToolkitTests(unittest.TestCase, metaclass=TestClassSetup):
    ...
    documented_tests: list[tuple[dict[str, Any], dict[str, Any]]]
    ...
    def documented_test(
        ...
        Args:
            ...
            expected (dict[str, Any], optional): Expected values. Defaults to None.
        ...
        if expected not in result and expected != result:
...
def run_testcase(testcase: type[ToolkitTests]) -> TestResult:
    ...
    """
    runner = unittest.TextTestRunner(stdout)
...
def run_tests() -> bool:
    ...
    for testcase in ToolkitTests.all_tests:
        ...
        tests_results = run_testcase(testcase) and tests_results
