...
def strptime(date_str, format_string):
    try:
    ...
    def _jp_parse(ds, jp_format, er, e):
        try:
            temp_format = _jp_replace(jp_format, er['era'], er['name'], e, e)
