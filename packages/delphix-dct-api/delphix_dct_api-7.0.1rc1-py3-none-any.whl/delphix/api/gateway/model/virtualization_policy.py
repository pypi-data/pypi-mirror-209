...
class VirtualizationPolicy(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, engine_id, policy_type, timezone_id, schedules, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            policy_type (str):
            timezone_id (str):
            schedules ([VirtualizationSchedule]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, engine_id, policy_type, timezone_id, schedules, *args, **kwargs):  # noqa: E501
        """VirtualizationPolicy - a model defined in OpenAPI
