...
class Service(object):
    ...
    def info(self, hostvars, service, show_passwords):
        ...
        if service == 'cloud':
            ...
            urls = [f'https://www.{domain}']
        elif service == 'hosteadashboard':
            urls = [f'https://hosteadashboard.{domain}']
        elif service == 'wekan':
            ...
            urls = [f'https://forgejo.{domain}']
            fields = ['forgejo_version']
            passwords = ['forgejo_password']
            files = ['playbooks/forgejo/roles/forgejo/defaults/main.yml']
        elif service == 'wazuh':
            fields = ['wazuh_mailto']
        elif service == 'icinga':
