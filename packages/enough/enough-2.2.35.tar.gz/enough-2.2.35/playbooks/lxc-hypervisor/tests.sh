...
source $(dirname $0)/files/lxc-helpers/lxc-helpers-lib.sh
...
EOF
    ...
    ansible-playbook --extra-vars lxc_prefix=10.99.0 --private-key ~/.ssh/id_rsa -i $inventory playbooks/lxc-hypervisor/lxc-playbook.yml
