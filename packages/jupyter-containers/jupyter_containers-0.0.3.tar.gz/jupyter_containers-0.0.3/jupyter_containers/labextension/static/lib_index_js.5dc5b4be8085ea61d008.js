"use strict";
(self["webpackChunk_datalayer_jupyter_containers"] = self["webpackChunk_datalayer_jupyter_containers"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'jupyter_containers', // API Namespace
    endPoint);
    let response;
    try {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "IJupyterContainers": () => (/* binding */ IJupyterContainers),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "jupyterContainers": () => (/* binding */ jupyterContainers)
/* harmony export */ });
...
/* harmony import */ var _datalayer_jupyter_docker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @datalayer/jupyter-docker */ "webpack/sharing/consume/default/@datalayer/jupyter-docker/@datalayer/jupyter-docker");
...
/* harmony import */ var _ws__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ws */ "./lib/ws.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./store */ "./lib/store/index.js");
...
const IJupyterContainers = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_5__.Token('@datalayer/jupyter-containers:plugin');
const jupyterContainers = {
    timer: _store__WEBPACK_IMPORTED_MODULE_7__.timer,
    TimerView: _store__WEBPACK_IMPORTED_MODULE_7__.TimerView,
};
/**
...
var CommandIDs;
(function (CommandIDs) {
    CommandIDs.create = 'create-jupyter-containers-widget';
...
const plugin = {
    ...
    autoStart: true,
    requires: [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ICommandPalette, _datalayer_jupyter_docker__WEBPACK_IMPORTED_MODULE_4__.IJupyterDocker],
    ...
    activate: (app, palette, jupyterDocker, settingRegistry, launcher) => {
        const { commands } = app;
        ...
        commands.addCommand(command, {
            ...
            execute: () => {
                const content = new _widget__WEBPACK_IMPORTED_MODULE_8__.DatalayerWidget(jupyterDocker);
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_9__.requestAPI)('get_example')
            .then(data => {
            console.log(data);
        })
            .catch(reason => {
            console.error(`The jupyter_containers server extension appears to be missing.\n${reason}`);
        });
        (0,_ws__WEBPACK_IMPORTED_MODULE_10__.connect)('ws://localhost:8888/jupyter_containers/echo', true);
...
const TimerView = (0,mobx_react__WEBPACK_IMPORTED_MODULE_2__.observer)(({ timer }) => ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", { onClick: () => timer.reset(), children: ["Jupyter Containers: ", timer.secondsPassed] })));
...
class DatalayerWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    _jupyterDocker;
    constructor(jupyterDocker) {
        super();
        this._jupyterDocker = jupyterDocker;
        this.addClass('dla-Containers');
    }
    render() {
        return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(this._jupyterDocker.TimerView, { timer: this._jupyterDocker.timer }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_component_MockComponent__WEBPACK_IMPORTED_MODULE_2__["default"], {})] });
    }
}
...
//# sourceMappingURL=lib_index_js.5dc5b4be8085ea61d008.js.map