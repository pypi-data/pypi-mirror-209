...
class JupyterContainersHandler(JupyterHandler):
    """JupyterContainersHandler"""
    ...
    def get(self):
        self.finish(json.dumps({
            "data": "This is /jupyter_containers/get_example endpoint!"
        }))
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_containers", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_containers", "echo")
    handlers = [
        (route_pattern, JupyterContainersHandler),
