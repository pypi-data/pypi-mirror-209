...
class ExperimentsApi(object):
    ...
    @validate_arguments
    def import_xlsx(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], body : Annotated[StrictStr, Field(..., description="Data (XLSX).")], timezone : Annotated[Optional[conint(strict=True, le=12, ge=-12)], Field(description="Timezone.")] = None, **kwargs) -> Experiment:  # noqa: E501
