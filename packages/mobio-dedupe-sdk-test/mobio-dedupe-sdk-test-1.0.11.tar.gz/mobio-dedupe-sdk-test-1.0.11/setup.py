...
version_dev='1.0.11'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='1.0.11',  # Required, Phần này cũng không được format file.
    ...
    data_files=[('mobio/sdks/dedupe',
                 ['mobio/sdks/dedupe/cpredicates.c', 'mobio/sdks/dedupe/cpredicates.cpython-38-x86_64-linux-gnu.so',
                  'mobio/sdks/dedupe/cpredicates.pyx'])],
