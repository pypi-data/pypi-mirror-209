...
class SelectionWheelUIControl(BaseUIControl):
    ...
    def SetTouchUpCallback(self, callbackFunc):
        # type: (function) -> None
        """
        设置轮盘选择切片并且鼠标按下抬起后触发回调函数，触发时机详见<a href="../../../../mcguide/18-界面与交互/30-UI说明文档.html#SelectionWheel">
        """
        pass
    ...
    def SetHoverCallback(self, callbackFunc):
        # type: (function) -> None
        """
        设置轮盘选择切片触发回调函数，触发时机详见<a href="../../../../mcguide/18-界面与交互/30-UI说明文档.html#SelectionWheel">
        """
        pass
