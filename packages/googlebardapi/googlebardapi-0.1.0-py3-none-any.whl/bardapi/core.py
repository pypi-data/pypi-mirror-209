...
class Bard:
    def __init__(self, token=None, timeout=10, proxies=None, session=None):
        """
        Initialize Bard
    ...
    def _get_snim0e(self):
        ...
        if resp.status_code != 200:
            raise Exception(f"Response code not 200. \n - Try Bard on https://bard.google.com/ \n "
    ...
    def get_answer(self, input_text: str) -> dict:
        ...
        self.conversation_id, self.response_id, self.choice_id = bard_answer["conversation_id"], bard_answer["response_id"], bard_answer["choices"][0]["id"]
        self._reqid += 100000
