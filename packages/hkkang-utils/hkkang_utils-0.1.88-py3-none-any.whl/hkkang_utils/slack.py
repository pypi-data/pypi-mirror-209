...
def send_message(
    ...
    try:
        ...
        print(f"Sending message to channel {channel}: {text}")
...
def slack_notification(channel: str, success_msg: str=None, error_msg: str=None, token: str = DEFAULT_ACCESS_TOKEN):
