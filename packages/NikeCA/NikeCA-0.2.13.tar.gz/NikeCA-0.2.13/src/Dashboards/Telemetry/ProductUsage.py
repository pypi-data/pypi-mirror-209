...
class ProductUsage(Telemetry):
    ...
    def product_viewed(self,
        ...
        query = f"""
            /*
            The query calculates the daily usage of different data products on different platforms, groups the data by 
            platform and product, and sorts the result in descending order based on the total usage
            */
            SELECT 
                {b}
                , PRODUCT_NAME
