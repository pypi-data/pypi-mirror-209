...
class Telemetry(Dashboards):
    ...
    def product_viewed(self,
        ...
        query = f"""
                /*
                The query calculates the daily usage of different data products on different platforms, groups the data 
                by platform and product, and sorts the result in descending order based on the total usage
                */
                SELECT 
                    {b}
                    , PRODUCT_NAME
    ...
    @staticmethod
    def telemetry_get_base_query(filters: list | None = None,
                                 start_date: str = '1900-01-01',
                                 end_date: str = '9999-12-31'
                                 ):
