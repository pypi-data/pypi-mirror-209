    ...
    try:
        ...
        try:
            for event in events:
                ...
                badge_number_field = event[settings.BADGE_NUMBER_SYNC_FIELD]
                ...
                if area:
                    ...
                    if user:
                        ...
                        rs2_logger.error(
                            f"No NEMO matching user found for {settings.BADGE_NUMBER_SYNC_FIELD} {badge_number_field} - {event_user} (event at location {reader.reader_name})"
                        )
