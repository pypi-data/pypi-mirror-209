...
class Generator(object):
    ...
    def __init__(self, root_dir, options={}):
        ...
        self._init_jinja({
            ...
            "get_resources": self._get_resouces,
    ...
    def _load_data_resources(self):
        ...
        # load the data from config.remote_resources
        """
        format:
            name:str
            request:dict
        ...
        if remote_resources := self.config.get("remote_resources"):
            for d in remote_resources:
                if name := d.get("name"):
    ...
    def create_page(self, build_dir, filepath, context={}, content=None, template=None, markup=None, layout=None):
        ...
        if "url" not in _context["page"]:
            ...
            print("NOT HERE", filepath, _context["page"]["url"])
