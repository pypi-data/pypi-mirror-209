...
class WNAffect:
    ...
    def __init__(self, wordnet_dir, wn_domains_dir):
    ...
    def _load_synsets(self, wn_domains_dir):
        ...
        a_synsets_xml_path = pkg_resources.resource_filename('textagon', 'external/extracted/wn-domains/wn-affect-1.1/a-synsets.xml')
        tree = ET.parse(a_synsets_xml_path)
        root = tree.getroot()
    ...
    def _load_emotions(self, wn_domains_dir):
        ...
        a_hierarchy_xml_path = pkg_resources.resource_filename('textagon', 'external/extracted/wn-domains/wn-affect-1.1/a-hierarchy.xml')
        tree = ET.parse(a_hierarchy_xml_path)
        root = tree.getroot()
