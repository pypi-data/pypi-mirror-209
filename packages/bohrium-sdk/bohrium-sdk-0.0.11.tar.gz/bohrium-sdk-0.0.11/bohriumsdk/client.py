...
class Client:
    ...
    def login(self):
        ...
        resp = requests.post('https://bohrium.dp.tech/account_gw/login', json=post_data).json()
        self.token = resp['token']
        print("Login successfully!")

    def generate_access_key(self, name="default"):
        post_data = { "name": name }
        resp = requests.post(url="https://bohrium.dp.tech/bohrapi/v1/ak/add", json=post_data).json()
