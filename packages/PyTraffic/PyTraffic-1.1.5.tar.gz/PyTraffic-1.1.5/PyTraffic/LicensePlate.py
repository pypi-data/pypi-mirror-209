...
''' This is the "LicensePlate" sub-module. '''
...
# Variables
SampleImage1 = directory + "/media/LicensePlate/images/1.jpg"
SampleImage2 = directory + "/media/LicensePlate/images/2.jpg"
SampleImage3 = directory + "/media/LicensePlate/images/3.jpg"
SampleImage4 = directory + "/media/LicensePlate/images/4.jpg"
SampleImage5 = directory + "/media/LicensePlate/images/5.jpg"
SampleImage6 = directory + "/media/LicensePlate/images/6.jpg"
SampleImage7 = directory + "/media/LicensePlate/images/7.jpg"
SampleImage8 = directory + "/media/LicensePlate/images/8.jpg"
...
def getLicensePlate(imagePath, show=False):
    # Variables
    tesseractPath = PyTraffic.tesseractPath

    # Check if Path Exists
    if (os.path.exists(imagePath)):
        # Check for Tesseract
        if (tesseractPath != None and tesseractPath != "Path Not Found"):
            # Check File Type
            mimetypes.init()
        ...
        elif (tesseractPath == None):
            raise Exception("Please initialize the module by running 'PyTraffic.init()'.")
        elif (tesseractPath == "Path Not Found"):
