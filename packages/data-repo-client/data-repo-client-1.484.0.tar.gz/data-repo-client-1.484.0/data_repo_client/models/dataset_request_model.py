...
class DatasetRequestModel(object):
    ...
    def __init__(self, name=None, description=None, default_profile_id=None, schema=None, region=None, cloud_platform=None, enable_secure_monitoring=False, phs_id=None, experimental_self_hosted=False, properties=None, dedicated_ingest_service_account=False, experimental_predictable_file_ids=False, policies=None, tags=None, local_vars_configuration=None):  # noqa: E501
