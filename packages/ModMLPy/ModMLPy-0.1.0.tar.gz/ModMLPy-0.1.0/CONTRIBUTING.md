...
Welcome to `ModMLPy` contributor's guide.
...
If you experience bugs or general issues with `ModMLPy`, please have a look
...
You can help improve `ModMLPy` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ModMLPy` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ModMLPy`'s files. While this mechanism can
...
```
conda create -n ModMLPy python=3 six virtualenv pytest pytest-cov
conda activate ModMLPy
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ModMLPy.git
   cd ModMLPy
   ```
...
5. Install [pre-commit]:
   ...
   `ModMLPy` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ModMLPy
[issue tracker]: https://github.com/<USERNAME>/ModMLPy/issues
