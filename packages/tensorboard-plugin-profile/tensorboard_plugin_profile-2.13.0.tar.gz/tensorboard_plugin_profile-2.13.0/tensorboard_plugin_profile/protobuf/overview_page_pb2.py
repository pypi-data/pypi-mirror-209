...
_OVERVIEWPAGEANALYSIS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_duty_cycle_percent', full_name='tensorflow.profiler.OverviewPageAnalysis.device_duty_cycle_percent', index=16,
...
_OVERVIEWPAGERUNENVIRONMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_independent_job_info', full_name='tensorflow.profiler.OverviewPageRunEnvironment.host_independent_job_info', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_dependent_job_info', full_name='tensorflow.profiler.OverviewPageRunEnvironment.host_dependent_job_info', index=6,
      number=8, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='replica_count', full_name='tensorflow.profiler.OverviewPageRunEnvironment.replica_count', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_cores_per_replica', full_name='tensorflow.profiler.OverviewPageRunEnvironment.num_cores_per_replica', index=8,
