...
def gltf(
    ...
    ''' Export scene as glTF 2.0 file :File: `addons/io_scene_gltf2/__init__.py\:668 <https://projects.blender.org/blender/blender-addons/addons/io_scene_gltf2/__init__.py#L668>`__
    ...
    :param export_bake_animation: Bake All Objects Animations, Force exporting animation on every objects. Can be useful when using constraints or driver. Also useful when exporting only selection
