...
@app.command()
def assign(
    device_type: Annotated[AssetType, typer.Option(
        ...,
        help='Type of device being updated')] = None,
    asset_tag: Annotated[str, typer.Option(
        help='Asset tag should be a 6 digit number')] = None,
    serial_number: Annotated[Optional[str], typer.Option(
        help='Serial Number of device')] = None,
    student_name: Annotated[Optional[str], typer.Option(
        help=' Student full name')] = None,
    homeroom: Annotated[Optional[str], typer.Option(
        help='Homeroom teachers last name')] = None,
    student_grade: Annotated[Optional[str], typer.Option(
        help='Student grade as a number')] = None,
    building: Annotated[Optional[str], typer.Option(
        help='Three letter building abbreviation. ex: COA')] = None,
    email_address: Annotated[Optional[str], typer.Option(
        help='Student email address')] = None,
    grad_year: Annotated[Optional[str], typer.Option(
        help='Year student graduates')] = None,
    owner: Annotated[Optional[str], typer.Option(
        help='Owner of device, this was used in the past as a way to target devices but should be deprecated')] = None,
    position: Annotated[Optional[str], typer.Option(
        help='For now, this will also be the Graduation year, will be transitioned to Student or Staff')] = None,
) -> None:
    """
