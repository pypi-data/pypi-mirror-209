...
class WidgetCodeModel extends base_1.DOMWidgetModel {
    ...
    initialize(...args) {
        ...
        base_1.DOMWidgetModel.prototype.initialize.apply(this, [attributes, options]);
    ...
    render() {
        ...
        this.el.innerHTML =
            cssStyles +
                ...
                '-body"></textarea>';
        _.defer(() => {
            this.mySignatureCodeMirror = codemirror_1.default.fromTextArea((document.getElementById(theTextareaId + '-signature')), {
                lineNumbers: true,
                firstLineNumber: 1,
                mode: {
                    name: 'python',
            ...
            this.mySignatureCodeMirror.display.wrapper.classList.add('widget-code-input-signature');
            this.myDocstringCodeMirror = codemirror_1.default.fromTextArea((document.getElementById(theTextareaId + '-docstring')), {
                lineNumbers: true,
            ...
            this.myDocstringCodeMirror.display.wrapper.classList.add('widget-code-input-docstring');
            this.myBodyCodeMirror = codemirror_1.default.fromTextArea(document.getElementById(theTextareaId + '-body'), {
                lineNumbers: true,
                //firstLineNumber: // This will be set later by changing the content, this
                // indirectly calls the function to update the line numbers
                mode: {
            ...
            this.model.on('change:function_parameters', this.signatureValueChanged, this);
