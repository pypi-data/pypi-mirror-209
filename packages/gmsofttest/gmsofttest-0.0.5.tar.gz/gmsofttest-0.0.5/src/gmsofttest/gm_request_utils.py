...
def send_get_request(request, url, headers=None, params=None, data=None, json=None, verify=None):
    response = request.get(url=url, headers=headers, params=params, data=data, json=json,
                               verify=verify)
    return response

def send_post_request(request, url, headers=None, params=None, data=None, json=None, verify=None):
    response = request.post(url=url, headers=headers, params=params, data=data, json=json,
                               verify=verify)
    return response

def send_put_request(request, url, headers=None, params=None, data=None, json=None, verify=None):
    response = request.put(url=url, headers=headers, params=params, data=data, json=json,
                               verify=verify)
    return response

def send_delete_request(request, url, headers=None, params=None, data=None, json=None, verify=None):
    response = request.delete(url=url, headers=headers, params=params, data=data, json=json,
                               verify=verify)
    return response

def send_options_request(request, url, headers=None, params=None, data=None, json=None, verify=None):
    response = request.options(url=url, headers=headers, params=params, data=data, json=json,
                               verify=verify)
    return response

def send_head_request(request, url, headers=None, params=None, data=None, json=None, verify=None):
