...
#include <qobject.h>
#line 12 "./sipfoolibcmodule.cpp"
#line 11 "foolib.sip"
#include <fooclass.h>
#line 15 "./sipfoolibcmodule.cpp"

/* Define the strings used by this module. */
const char sipStrings_foolib[] = {
...
static sipTypeDef *typesTable[] = {
    &sipTypeDef_foolib_FooClass.super.ctd_base,
    &sipTypeDef_foolib_FooMenu.super.ctd_base,
};
...
sipExportedModuleDef sipModuleAPI_foolib = {
    0,
    SIP_API_MINOR_NR,
    sipNameNr_foolib,
    0,
...
const sipAPIDef *sipAPI_foolib;
const sipExportedModuleDef *sipModuleAPI_foolib_QtCore;
const sipExportedModuleDef *sipModuleAPI_foolib_QtGui;

sip_qt_metaobject_func sip_foolib_qt_metaobject;
sip_qt_metacall_func sip_foolib_qt_metacall;
sip_qt_metacast_func sip_foolib_qt_metacast;


/* The Python module initialisation function. */
#if PY_MAJOR_VERSION >= 3
#define SIP_MODULE_ENTRY        PyInit_foolib
#define SIP_MODULE_TYPE         PyObject *
#define SIP_MODULE_DISCARD(r)   Py_DECREF(r)
#define SIP_MODULE_RETURN(r)    return (r)
#else
#define SIP_MODULE_ENTRY        initfoolib
...
#endif
{
    ...
    sipModule = Py_InitModule(sipName_foolib, sip_methods);
#else
    sipModule = Py_InitModule(const_cast<char *>(sipName_foolib), sip_methods);
#endif
...
#if defined(SIP_USE_PYCAPSULE)
    sipAPI_foolib = reinterpret_cast<const sipAPIDef *>(PyCapsule_GetPointer(sip_capiobj, SIP_MODULE_NAME "._C_API"));
#else
    sipAPI_foolib = reinterpret_cast<const sipAPIDef *>(PyCObject_AsVoidPtr(sip_capiobj));
#endif

#if defined(SIP_USE_PYCAPSULE)
    if (sipAPI_foolib == NULL)
    {
        SIP_MODULE_DISCARD(sipModule);
        SIP_MODULE_RETURN(NULL);
    }
    ...
    if (sipExportModule(&sipModuleAPI_foolib,SIP_API_MAJOR_NR,SIP_API_MINOR_NR,0) < 0)
    {
        SIP_MODULE_DISCARD(sipModule);
        SIP_MODULE_RETURN(0);
    }

    sip_foolib_qt_metaobject = (sip_qt_metaobject_func)sipImportSymbol("qtcore_qt_metaobject");
    sip_foolib_qt_metacall = (sip_qt_metacall_func)sipImportSymbol("qtcore_qt_metacall");
    sip_foolib_qt_metacast = (sip_qt_metacast_func)sipImportSymbol("qtcore_qt_metacast");

    if (!sip_foolib_qt_metacast)
        Py_FatalError("Unable to import qtcore_qt_metacast");

    /* Initialise the module now all its dependencies have been set up. */
    if (sipInitModule(&sipModuleAPI_foolib,sipModuleDict) < 0)
    {
        SIP_MODULE_DISCARD(sipModule);
        SIP_MODULE_RETURN(0);
    }
    ...
    sipModuleAPI_foolib_QtCore = sipModuleAPI_foolib.em_imports[0].im_module;
    sipModuleAPI_foolib_QtGui = sipModuleAPI_foolib.em_imports[1].im_module;
