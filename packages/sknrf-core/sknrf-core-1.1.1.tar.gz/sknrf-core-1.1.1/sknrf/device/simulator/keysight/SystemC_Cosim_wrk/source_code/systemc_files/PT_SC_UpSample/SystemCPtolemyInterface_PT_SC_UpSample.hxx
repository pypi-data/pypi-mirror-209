...
#ifndef SystemCPtolemyInterface_PT_SC_UpSample_H_INCLUDE 
#define SystemCPtolemyInterface_PT_SC_UpSample_H_INCLUDE


#include <systemc.h>

/** Forward declaration of opaque structures used in SystemCPtolemyInterface_PT_SC_UpSample */
extern "C" 
 { 
...
/**
@class SystemCPtolemyInterface_PT_SC_UpSample Interface class 
 ...
 */
class SystemCPtolemyInterface_PT_SC_UpSample : public sc_module { 
public: 
...
*/
	 sc_fifo_out<double> input; /**< Connect this to corresponding "INPUT" in your SystemC design.*/
...
*/
	 sc_fifo_in<double> output; /**< Connect this to corresponding "OUTPUT" in your SystemC design.*/
...
*/
	 SCADS_Interface * Factor; /**< Parameter Interface.*/
	 SCADS_Interface * Phase; /**< Parameter Interface.*/
	 SCADS_Interface * Fill; /**< Parameter Interface.*/

	 SC_HAS_PROCESS(SystemCPtolemyInterface_PT_SC_UpSample);

	 SystemCPtolemyInterface_PT_SC_UpSample(sc_module_name name, char * connectiontoken);
	 ~SystemCPtolemyInterface_PT_SC_UpSample();
