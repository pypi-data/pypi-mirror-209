...
PyTypeObject **SbkqprogressindicatorTypes = nullptr;
// Current module's PyObject pointer.
PyObject *SbkqprogressindicatorModuleObject = nullptr;
// Current module's converter array.
SbkConverter **SbkqprogressindicatorTypeConverters = nullptr;
void cleanTypesAttributes() {
    static PyObject *attrName = Shiboken::PyName::qtStaticMetaObject();
    for (int i = 0, imax = SBK_qprogressindicator_IDX_COUNT; i < imax; i++) {
        PyObject *pyType = reinterpret_cast<PyObject *>(SbkqprogressindicatorTypes[i]);
...
static PyMethodDef qprogressindicator_methods[] = {
...
static struct PyModuleDef moduledef = {
    ...
    /* m_name     */ "qprogressindicator",
    /* m_doc      */ nullptr,
    /* m_size     */ -1,
    /* m_methods  */ qprogressindicator_methods,
    /* m_reload   */ nullptr,
    /* m_traverse */ nullptr,
    /* m_clear    */ nullptr,
    /* m_free     */ nullptr
...
extern "C" LIBSHIBOKEN_EXPORT PyObject *PyInit_qprogressindicator()
{
    if (SbkqprogressindicatorModuleObject != nullptr)
        return SbkqprogressindicatorModuleObject;
    {
    ...
    static PyTypeObject *cppApi[SBK_qprogressindicator_IDX_COUNT];
    SbkqprogressindicatorTypes = cppApi;

    // Create an array of primitive type converters for the current module.
    static SbkConverter *sbkConverters[SBK_qprogressindicator_CONVERTERS_IDX_COUNT];
    SbkqprogressindicatorTypeConverters = sbkConverters;

    PyObject *module = Shiboken::Module::create("qprogressindicator", &moduledef);

    // Make module available from global scope
    SbkqprogressindicatorModuleObject = module;

    // Initialize classes in the type system
    init_QProgressIndicator(module);

    // Register converter for type 'QList<int>'.
    SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_INT_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_int__CppToPython__QList_int_);
    Shiboken::Conversions::registerConverterName(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_INT_IDX], "QList<int>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_INT_IDX],
        _QList_int__PythonToCpp__QList_int_,
        is__QList_int__PythonToCpp__QList_int__Convertible);
    Shiboken::Conversions::setPythonToCppPointerFunctions(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_INT_IDX],
        PythonToCppQIntList,
        isQIntListPythonToCppConvertible);

    // Register converter for type 'QList<QAction*>'.
    SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_QACTIONPTR_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QActionPTR__CppToPython__QList_QActionPTR_);
    Shiboken::Conversions::registerConverterName(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_QACTIONPTR_IDX], "QList<QAction*>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_QACTIONPTR_IDX],
    ...
    SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QVariant__CppToPython__QList_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_QVARIANT_IDX], "QList<QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_QVARIANT_IDX],
        _QList_QVariant__PythonToCpp__QList_QVariant_,
        is__QList_QVariant__PythonToCpp__QList_QVariant__Convertible);

    // Register converter for type 'QList<QString>'.
    SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QString__CppToPython__QList_QString_);
    Shiboken::Conversions::registerConverterName(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_QSTRING_IDX], "QList<QString>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QLIST_QSTRING_IDX],
        _QList_QString__PythonToCpp__QList_QString_,
        is__QList_QString__PythonToCpp__QList_QString__Convertible);

    // Register converter for type 'QMap<QString,QVariant>'.
    SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QMAP_QSTRING_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyDict_Type, _QMap_QString_QVariant__CppToPython__QMap_QString_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QMAP_QSTRING_QVARIANT_IDX], "QMap<QString,QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkqprogressindicatorTypeConverters[SBK_QPROGRESSINDICATOR_QMAP_QSTRING_QVARIANT_IDX],
    ...
    Shiboken::Module::registerTypes(module, SbkqprogressindicatorTypes);
    Shiboken::Module::registerTypeConverters(module, SbkqprogressindicatorTypeConverters);

    if (PyErr_Occurred()) {
        PyErr_Print();
        Py_FatalError("can't initialize module qprogressindicator");
    }
    PySide::registerCleanupFunction(cleanTypesAttributes);

    FinishSignatureInitialization(module, qprogressindicator_SignatureStrings);
