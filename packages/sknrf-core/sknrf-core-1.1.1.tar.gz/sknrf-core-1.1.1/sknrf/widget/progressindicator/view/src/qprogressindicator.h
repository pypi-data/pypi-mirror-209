...
#if defined(QPROGRESSINDICATOR_COMPILE_LIBRARY)
#  define QPROGRESSINDICATOR_DECL  Q_DECL_EXPORT
#elif defined(QPROGRESSINDICATOR_USE_LIBRARY)
#  define QPROGRESSINDICATOR_DECL Q_DECL_IMPORT
#else
#  define QPROGRESSINDICATOR_DECL
#endif
...
/*! 
    ...
    \sa QProgressBar
*/
class QPROGRESSINDICATOR_DECL  QProgressIndicator : public QWidget
{
    Q_OBJECT
