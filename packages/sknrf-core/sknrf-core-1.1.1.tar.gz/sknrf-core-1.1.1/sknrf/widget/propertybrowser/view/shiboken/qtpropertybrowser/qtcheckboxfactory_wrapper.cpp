...
{
    qRegisterMetaType< ::QtCheckBoxFactory *>();
}

void QtCheckBoxFactoryWrapper::resetPyMethodCache()
{
...
void QtCheckBoxFactoryWrapper::connectPropertyManager(QtBoolPropertyManager * manager)
{
    if (m_PyMethodCache[0]) {
        return this->::QtCheckBoxFactory::connectPropertyManager(manager);
    }
    ...
    Shiboken::AutoDecRef pyArgs(Py_BuildValue("(N)",
        Shiboken::Conversions::pointerToPython(SbkqtpropertybrowserTypes[SBK_QTBOOLPROPERTYMANAGER_IDX], manager)
    ));
...
QWidget * QtCheckBoxFactoryWrapper::createAttributeEditor(QtBoolPropertyManager * manager, QtProperty * property, QWidget * parent, BrowserCol attribute)
{
    ...
    if (!pythonToCpp) {
        Shiboken::Warnings::warnInvalidReturnValue("QtCheckBoxFactory", "createAttributeEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
...
QWidget * QtCheckBoxFactoryWrapper::createEditor(QtBoolPropertyManager * manager, QtProperty * property, QWidget * parent)
{
    ...
    Shiboken::Conversions::PythonToCppConversion pythonToCpp =
        Shiboken::Conversions::pythonToCppPointerConversion(SbkPySide6_QtWidgetsTypes[SBK_QWIDGET_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::Warnings::warnInvalidReturnValue("QtCheckBoxFactory", "createEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtCheckBoxFactoryWrapper::disconnectPropertyManager(QtBoolPropertyManager * manager)
{
    if (m_PyMethodCache[3]) {
        return this->::QtCheckBoxFactory::disconnectPropertyManager(manager);
    }
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return;
...
Sbk_QtCheckBoxFactory_Init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    static const char fullName[] = "qtpropertybrowser.QtCheckBoxFactory.__init__";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_QtCheckBoxFactoryFunc_connectPropertyManager(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto *cppSelf = static_cast<QtCheckBoxFactoryWrapper *>(reinterpret_cast< ::QtCheckBoxFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTCHECKBOXFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    SBK_UNUSED(cppSelf)
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtCheckBoxFactory.connectPropertyManager";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    Shiboken::Conversions::PythonToCppConversion pythonToCpp;
    SBK_UNUSED(pythonToCpp)
    ...
    if ((pythonToCpp = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTBOOLPROPERTYMANAGER_IDX], (pyArg)))) {
...
static PyObject *Sbk_QtCheckBoxFactoryFunc_createAttributeEditor(PyObject *self, PyObject *args)
{
    ...
    PyObject *pyResult{};
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtCheckBoxFactory.createAttributeEditor";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    ...
    // Overloaded function decisor
    // 0: QtCheckBoxFactory::createAttributeEditor(QtBoolPropertyManager*,QtProperty*,QWidget*,BrowserCol)->QWidget*
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTBOOLPROPERTYMANAGER_IDX], (pyArgs[0])))
...
static PyObject *Sbk_QtCheckBoxFactoryFunc_createEditor(PyObject *self, PyObject *args)
{
    ...
    PyObject *pyResult{};
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtCheckBoxFactory.createEditor";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    ...
    // Overloaded function decisor
    // 0: QtCheckBoxFactory::createEditor(QtBoolPropertyManager*,QtProperty*,QWidget*)->QWidget*
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTBOOLPROPERTYMANAGER_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX], (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::pythonToCppPointerConversion(SbkPySide6_QtWidgetsTypes[SBK_QWIDGET_IDX], (pyArgs[2])))) {
...
static PyObject *Sbk_QtCheckBoxFactoryFunc_disconnectPropertyManager(PyObject *self, PyObject *pyArg)
{
    ...
    SBK_UNUSED(cppSelf)
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtCheckBoxFactory.disconnectPropertyManager";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    Shiboken::Conversions::PythonToCppConversion pythonToCpp;
    SBK_UNUSED(pythonToCpp)
...
static const char *Sbk_QtCheckBoxFactory_PropertyStrings[] = {
    nullptr // Sentinel
};

static PyMethodDef Sbk_QtCheckBoxFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtCheckBoxFactoryFunc_connectPropertyManager), METH_O, nullptr},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtCheckBoxFactoryFunc_createAttributeEditor), METH_VARARGS, nullptr},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtCheckBoxFactoryFunc_createEditor), METH_VARARGS, nullptr},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtCheckBoxFactoryFunc_disconnectPropertyManager), METH_O, nullptr},

    {nullptr, nullptr, 0, nullptr} // Sentinel
};

static int Sbk_QtCheckBoxFactory_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    PySide::Feature::Select(self);
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::QtCheckBoxFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTCHECKBOXFACTORY_IDX], reinterpret_cast<SbkObject *>(self)));
        auto inst = dynamic_cast<QtCheckBoxFactoryWrapper *>(plain_inst);
        if (inst)
...
// Class Definition -----------------------------------------------
extern "C" {
static PyTypeObject *_Sbk_QtCheckBoxFactory_Type = nullptr;
static PyTypeObject *Sbk_QtCheckBoxFactory_TypeF(void)
{
...
static PyType_Slot Sbk_QtCheckBoxFactory_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_QtCheckBoxFactory_setattro)},
...
static PyType_Spec Sbk_QtCheckBoxFactory_spec = {
    "1:qtpropertybrowser.QtCheckBoxFactory",
    sizeof(SbkObject),
    0,
...
static PythonToCppFunc is_QtCheckBoxFactory_PythonToCpp_QtCheckBoxFactory_PTR_Convertible(PyObject *pyIn)
{
    ...
    if (PyObject_TypeCheck(pyIn, Sbk_QtCheckBoxFactory_TypeF()))
...
static const char *QtCheckBoxFactory_SignatureStrings[] = {
    "qtpropertybrowser.QtCheckBoxFactory(self,parent:PySide6.QtCore.QObject=0)",
    "qtpropertybrowser.QtCheckBoxFactory.connectPropertyManager(self,manager:qtpropertybrowser.QtBoolPropertyManager)",
    "qtpropertybrowser.QtCheckBoxFactory.createAttributeEditor(self,manager:qtpropertybrowser.QtBoolPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide6.QtWidgets.QWidget,attribute:qtpropertybrowser.BrowserCol)->PySide6.QtWidgets.QWidget",
    "qtpropertybrowser.QtCheckBoxFactory.createEditor(self,manager:qtpropertybrowser.QtBoolPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide6.QtWidgets.QWidget)->PySide6.QtWidgets.QWidget",
    "qtpropertybrowser.QtCheckBoxFactory.disconnectPropertyManager(self,manager:qtpropertybrowser.QtBoolPropertyManager)",
    nullptr}; // Sentinel
...
void init_QtCheckBoxFactory(PyObject *module)
{
    _Sbk_QtCheckBoxFactory_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        0,
        0);
    auto *pyType = Sbk_QtCheckBoxFactory_TypeF(); // references _Sbk_QtCheckBoxFactory_Type
    InitSignatureStrings(pyType, QtCheckBoxFactory_SignatureStrings);
    SbkObjectType_SetPropertyStrings(pyType, Sbk_QtCheckBoxFactory_PropertyStrings);
    SbkqtpropertybrowserTypes[SBK_QTCHECKBOXFACTORY_IDX] = pyType;
