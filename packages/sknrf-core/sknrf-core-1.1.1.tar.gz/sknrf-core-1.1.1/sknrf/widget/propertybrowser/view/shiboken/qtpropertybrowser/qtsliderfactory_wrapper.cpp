...
{
    qRegisterMetaType< ::QtSliderFactory *>();
}

void QtSliderFactoryWrapper::resetPyMethodCache()
{
...
void QtSliderFactoryWrapper::connectPropertyManager(QtIntPropertyManager * manager)
{
    if (m_PyMethodCache[0]) {
        return this->::QtSliderFactory::connectPropertyManager(manager);
    }
...
QWidget * QtSliderFactoryWrapper::createAttributeEditor(QtIntPropertyManager * manager, QtProperty * property, QWidget * parent, BrowserCol attribute)
{
    ...
    if (!pythonToCpp) {
        Shiboken::Warnings::warnInvalidReturnValue("QtSliderFactory", "createAttributeEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
...
QWidget * QtSliderFactoryWrapper::createEditor(QtIntPropertyManager * manager, QtProperty * property, QWidget * parent)
{
    ...
    Shiboken::Conversions::PythonToCppConversion pythonToCpp =
        Shiboken::Conversions::pythonToCppPointerConversion(SbkPySide6_QtWidgetsTypes[SBK_QWIDGET_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::Warnings::warnInvalidReturnValue("QtSliderFactory", "createEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtSliderFactoryWrapper::disconnectPropertyManager(QtIntPropertyManager * manager)
{
    if (m_PyMethodCache[3]) {
        return this->::QtSliderFactory::disconnectPropertyManager(manager);
    }
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return;
...
Sbk_QtSliderFactory_Init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    static const char fullName[] = "qtpropertybrowser.QtSliderFactory.__init__";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_QtSliderFactoryFunc_connectPropertyManager(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto *cppSelf = static_cast<QtSliderFactoryWrapper *>(reinterpret_cast< ::QtSliderFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTSLIDERFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    SBK_UNUSED(cppSelf)
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtSliderFactory.connectPropertyManager";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    Shiboken::Conversions::PythonToCppConversion pythonToCpp;
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_QtSliderFactoryFunc_createAttributeEditor(PyObject *self, PyObject *args)
{
    ...
    PyObject *pyResult{};
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtSliderFactory.createAttributeEditor";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    ...
    // Overloaded function decisor
    // 0: QtSliderFactory::createAttributeEditor(QtIntPropertyManager*,QtProperty*,QWidget*,BrowserCol)->QWidget*
    if (numArgs == 4
...
static PyObject *Sbk_QtSliderFactoryFunc_createEditor(PyObject *self, PyObject *args)
{
    ...
    PyObject *pyResult{};
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtSliderFactory.createEditor";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    ...
    // Overloaded function decisor
    // 0: QtSliderFactory::createEditor(QtIntPropertyManager*,QtProperty*,QWidget*)->QWidget*
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTINTPROPERTYMANAGER_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX], (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::pythonToCppPointerConversion(SbkPySide6_QtWidgetsTypes[SBK_QWIDGET_IDX], (pyArgs[2])))) {
...
static PyObject *Sbk_QtSliderFactoryFunc_disconnectPropertyManager(PyObject *self, PyObject *pyArg)
{
    ...
    SBK_UNUSED(cppSelf)
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtSliderFactory.disconnectPropertyManager";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    Shiboken::Conversions::PythonToCppConversion pythonToCpp;
    SBK_UNUSED(pythonToCpp)
...
static const char *Sbk_QtSliderFactory_PropertyStrings[] = {
    nullptr // Sentinel
};

static PyMethodDef Sbk_QtSliderFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtSliderFactoryFunc_connectPropertyManager), METH_O, nullptr},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtSliderFactoryFunc_createAttributeEditor), METH_VARARGS, nullptr},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtSliderFactoryFunc_createEditor), METH_VARARGS, nullptr},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtSliderFactoryFunc_disconnectPropertyManager), METH_O, nullptr},

    {nullptr, nullptr, 0, nullptr} // Sentinel
};

static int Sbk_QtSliderFactory_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    PySide::Feature::Select(self);
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::QtSliderFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTSLIDERFACTORY_IDX], reinterpret_cast<SbkObject *>(self)));
        auto inst = dynamic_cast<QtSliderFactoryWrapper *>(plain_inst);
        if (inst)
...
// Class Definition -----------------------------------------------
extern "C" {
static PyTypeObject *_Sbk_QtSliderFactory_Type = nullptr;
static PyTypeObject *Sbk_QtSliderFactory_TypeF(void)
{
...
static PyType_Slot Sbk_QtSliderFactory_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_QtSliderFactory_setattro)},
...
static PyType_Spec Sbk_QtSliderFactory_spec = {
    "1:qtpropertybrowser.QtSliderFactory",
    sizeof(SbkObject),
    0,
...
static PythonToCppFunc is_QtSliderFactory_PythonToCpp_QtSliderFactory_PTR_Convertible(PyObject *pyIn)
{
    ...
    if (PyObject_TypeCheck(pyIn, Sbk_QtSliderFactory_TypeF()))
...
static const char *QtSliderFactory_SignatureStrings[] = {
    "qtpropertybrowser.QtSliderFactory(self,parent:PySide6.QtCore.QObject=0)",
    "qtpropertybrowser.QtSliderFactory.connectPropertyManager(self,manager:qtpropertybrowser.QtIntPropertyManager)",
    "qtpropertybrowser.QtSliderFactory.createAttributeEditor(self,manager:qtpropertybrowser.QtIntPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide6.QtWidgets.QWidget,attribute:qtpropertybrowser.BrowserCol)->PySide6.QtWidgets.QWidget",
    "qtpropertybrowser.QtSliderFactory.createEditor(self,manager:qtpropertybrowser.QtIntPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide6.QtWidgets.QWidget)->PySide6.QtWidgets.QWidget",
    "qtpropertybrowser.QtSliderFactory.disconnectPropertyManager(self,manager:qtpropertybrowser.QtIntPropertyManager)",
    nullptr}; // Sentinel
...
void init_QtSliderFactory(PyObject *module)
{
    _Sbk_QtSliderFactory_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        0,
        0);
    auto *pyType = Sbk_QtSliderFactory_TypeF(); // references _Sbk_QtSliderFactory_Type
    InitSignatureStrings(pyType, QtSliderFactory_SignatureStrings);
    SbkObjectType_SetPropertyStrings(pyType, Sbk_QtSliderFactory_PropertyStrings);
    SbkqtpropertybrowserTypes[SBK_QTSLIDERFACTORY_IDX] = pyType;
