...
{
    qRegisterMetaType< ::QtEnumEditorFactory *>();
}

void QtEnumEditorFactoryWrapper::resetPyMethodCache()
{
...
void QtEnumEditorFactoryWrapper::connectPropertyManager(QtEnumPropertyManager * manager)
{
    if (m_PyMethodCache[0]) {
        return this->::QtEnumEditorFactory::connectPropertyManager(manager);
    }
    ...
    Shiboken::AutoDecRef pyArgs(Py_BuildValue("(N)",
        Shiboken::Conversions::pointerToPython(SbkqtpropertybrowserTypes[SBK_QTENUMPROPERTYMANAGER_IDX], manager)
    ));
...
QWidget * QtEnumEditorFactoryWrapper::createAttributeEditor(QtEnumPropertyManager * manager, QtProperty * property, QWidget * parent, BrowserCol attribute)
{
    ...
    if (!pythonToCpp) {
        Shiboken::Warnings::warnInvalidReturnValue("QtEnumEditorFactory", "createAttributeEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
...
QWidget * QtEnumEditorFactoryWrapper::createEditor(QtEnumPropertyManager * manager, QtProperty * property, QWidget * parent)
{
    ...
    Shiboken::Conversions::PythonToCppConversion pythonToCpp =
        Shiboken::Conversions::pythonToCppPointerConversion(SbkPySide6_QtWidgetsTypes[SBK_QWIDGET_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::Warnings::warnInvalidReturnValue("QtEnumEditorFactory", "createEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtEnumEditorFactoryWrapper::disconnectPropertyManager(QtEnumPropertyManager * manager)
{
    if (m_PyMethodCache[3]) {
        return this->::QtEnumEditorFactory::disconnectPropertyManager(manager);
    }
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return;
...
Sbk_QtEnumEditorFactory_Init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    static const char fullName[] = "qtpropertybrowser.QtEnumEditorFactory.__init__";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_QtEnumEditorFactoryFunc_connectPropertyManager(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto *cppSelf = static_cast<QtEnumEditorFactoryWrapper *>(reinterpret_cast< ::QtEnumEditorFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTENUMEDITORFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    SBK_UNUSED(cppSelf)
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtEnumEditorFactory.connectPropertyManager";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    Shiboken::Conversions::PythonToCppConversion pythonToCpp;
    SBK_UNUSED(pythonToCpp)
    ...
    if ((pythonToCpp = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTENUMPROPERTYMANAGER_IDX], (pyArg)))) {
...
static PyObject *Sbk_QtEnumEditorFactoryFunc_createAttributeEditor(PyObject *self, PyObject *args)
{
    ...
    PyObject *pyResult{};
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtEnumEditorFactory.createAttributeEditor";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    ...
    // Overloaded function decisor
    // 0: QtEnumEditorFactory::createAttributeEditor(QtEnumPropertyManager*,QtProperty*,QWidget*,BrowserCol)->QWidget*
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTENUMPROPERTYMANAGER_IDX], (pyArgs[0])))
...
static PyObject *Sbk_QtEnumEditorFactoryFunc_createEditor(PyObject *self, PyObject *args)
{
    ...
    PyObject *pyResult{};
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtEnumEditorFactory.createEditor";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    ...
    // Overloaded function decisor
    // 0: QtEnumEditorFactory::createEditor(QtEnumPropertyManager*,QtProperty*,QWidget*)->QWidget*
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTENUMPROPERTYMANAGER_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX], (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::pythonToCppPointerConversion(SbkPySide6_QtWidgetsTypes[SBK_QWIDGET_IDX], (pyArgs[2])))) {
...
static PyObject *Sbk_QtEnumEditorFactoryFunc_disconnectPropertyManager(PyObject *self, PyObject *pyArg)
{
    ...
    SBK_UNUSED(cppSelf)
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtEnumEditorFactory.disconnectPropertyManager";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    Shiboken::Conversions::PythonToCppConversion pythonToCpp;
    SBK_UNUSED(pythonToCpp)
...
static const char *Sbk_QtEnumEditorFactory_PropertyStrings[] = {
    nullptr // Sentinel
};

static PyMethodDef Sbk_QtEnumEditorFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtEnumEditorFactoryFunc_connectPropertyManager), METH_O, nullptr},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtEnumEditorFactoryFunc_createAttributeEditor), METH_VARARGS, nullptr},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtEnumEditorFactoryFunc_createEditor), METH_VARARGS, nullptr},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtEnumEditorFactoryFunc_disconnectPropertyManager), METH_O, nullptr},

    {nullptr, nullptr, 0, nullptr} // Sentinel
};

static int Sbk_QtEnumEditorFactory_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    PySide::Feature::Select(self);
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::QtEnumEditorFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTENUMEDITORFACTORY_IDX], reinterpret_cast<SbkObject *>(self)));
        auto inst = dynamic_cast<QtEnumEditorFactoryWrapper *>(plain_inst);
        if (inst)
...
// Class Definition -----------------------------------------------
extern "C" {
static PyTypeObject *_Sbk_QtEnumEditorFactory_Type = nullptr;
static PyTypeObject *Sbk_QtEnumEditorFactory_TypeF(void)
{
...
static PyType_Slot Sbk_QtEnumEditorFactory_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_QtEnumEditorFactory_setattro)},
...
static PyType_Spec Sbk_QtEnumEditorFactory_spec = {
    "1:qtpropertybrowser.QtEnumEditorFactory",
    sizeof(SbkObject),
    0,
...
static PythonToCppFunc is_QtEnumEditorFactory_PythonToCpp_QtEnumEditorFactory_PTR_Convertible(PyObject *pyIn)
{
    ...
    if (PyObject_TypeCheck(pyIn, Sbk_QtEnumEditorFactory_TypeF()))
...
static const char *QtEnumEditorFactory_SignatureStrings[] = {
    "qtpropertybrowser.QtEnumEditorFactory(self,parent:PySide6.QtCore.QObject=0)",
    "qtpropertybrowser.QtEnumEditorFactory.connectPropertyManager(self,manager:qtpropertybrowser.QtEnumPropertyManager)",
    "qtpropertybrowser.QtEnumEditorFactory.createAttributeEditor(self,manager:qtpropertybrowser.QtEnumPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide6.QtWidgets.QWidget,attribute:qtpropertybrowser.BrowserCol)->PySide6.QtWidgets.QWidget",
    "qtpropertybrowser.QtEnumEditorFactory.createEditor(self,manager:qtpropertybrowser.QtEnumPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide6.QtWidgets.QWidget)->PySide6.QtWidgets.QWidget",
    "qtpropertybrowser.QtEnumEditorFactory.disconnectPropertyManager(self,manager:qtpropertybrowser.QtEnumPropertyManager)",
    nullptr}; // Sentinel
...
void init_QtEnumEditorFactory(PyObject *module)
{
    _Sbk_QtEnumEditorFactory_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        0,
        0);
    auto *pyType = Sbk_QtEnumEditorFactory_TypeF(); // references _Sbk_QtEnumEditorFactory_Type
    InitSignatureStrings(pyType, QtEnumEditorFactory_SignatureStrings);
    SbkObjectType_SetPropertyStrings(pyType, Sbk_QtEnumEditorFactory_PropertyStrings);
    SbkqtpropertybrowserTypes[SBK_QTENUMEDITORFACTORY_IDX] = pyType;
