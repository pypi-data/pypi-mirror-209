...
{
    qRegisterMetaType< ::QtSizeEditorFactory *>();
}

void QtSizeEditorFactoryWrapper::resetPyMethodCache()
{
...
void QtSizeEditorFactoryWrapper::connectPropertyManager(QtSizePropertyManager * manager)
{
    if (m_PyMethodCache[0]) {
        return this->::QtSizeEditorFactory::connectPropertyManager(manager);
    }
    ...
    Shiboken::AutoDecRef pyArgs(Py_BuildValue("(N)",
        Shiboken::Conversions::pointerToPython(SbkqtpropertybrowserTypes[SBK_QTSIZEPROPERTYMANAGER_IDX], manager)
    ));
...
QWidget * QtSizeEditorFactoryWrapper::createAttributeEditor(QtSizePropertyManager * manager, QtProperty * property, QWidget * parent, BrowserCol attribute)
{
    ...
    if (!pythonToCpp) {
        Shiboken::Warnings::warnInvalidReturnValue("QtSizeEditorFactory", "createAttributeEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
...
QWidget * QtSizeEditorFactoryWrapper::createEditor(QtSizePropertyManager * manager, QtProperty * property, QWidget * parent)
{
    ...
    Shiboken::Conversions::PythonToCppConversion pythonToCpp =
        Shiboken::Conversions::pythonToCppPointerConversion(SbkPySide6_QtWidgetsTypes[SBK_QWIDGET_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::Warnings::warnInvalidReturnValue("QtSizeEditorFactory", "createEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtSizeEditorFactoryWrapper::disconnectPropertyManager(QtSizePropertyManager * manager)
{
    if (m_PyMethodCache[3]) {
        return this->::QtSizeEditorFactory::disconnectPropertyManager(manager);
    }
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return;
...
Sbk_QtSizeEditorFactory_Init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    static const char fullName[] = "qtpropertybrowser.QtSizeEditorFactory.__init__";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_QtSizeEditorFactoryFunc_connectPropertyManager(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto *cppSelf = static_cast<QtSizeEditorFactoryWrapper *>(reinterpret_cast< ::QtSizeEditorFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTSIZEEDITORFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    SBK_UNUSED(cppSelf)
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtSizeEditorFactory.connectPropertyManager";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    Shiboken::Conversions::PythonToCppConversion pythonToCpp;
    SBK_UNUSED(pythonToCpp)
    ...
    if ((pythonToCpp = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTSIZEPROPERTYMANAGER_IDX], (pyArg)))) {
...
static PyObject *Sbk_QtSizeEditorFactoryFunc_createAttributeEditor(PyObject *self, PyObject *args)
{
    ...
    PyObject *pyResult{};
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtSizeEditorFactory.createAttributeEditor";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    ...
    // Overloaded function decisor
    // 0: QtSizeEditorFactory::createAttributeEditor(QtSizePropertyManager*,QtProperty*,QWidget*,BrowserCol)->QWidget*
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTSIZEPROPERTYMANAGER_IDX], (pyArgs[0])))
...
static PyObject *Sbk_QtSizeEditorFactoryFunc_createEditor(PyObject *self, PyObject *args)
{
    ...
    PyObject *pyResult{};
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtSizeEditorFactory.createEditor";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    ...
    // Overloaded function decisor
    // 0: QtSizeEditorFactory::createEditor(QtSizePropertyManager*,QtProperty*,QWidget*)->QWidget*
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTSIZEPROPERTYMANAGER_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::pythonToCppPointerConversion(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX], (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::pythonToCppPointerConversion(SbkPySide6_QtWidgetsTypes[SBK_QWIDGET_IDX], (pyArgs[2])))) {
...
static PyObject *Sbk_QtSizeEditorFactoryFunc_disconnectPropertyManager(PyObject *self, PyObject *pyArg)
{
    ...
    SBK_UNUSED(cppSelf)
    Shiboken::AutoDecRef errInfo{};
    static const char fullName[] = "qtpropertybrowser.QtSizeEditorFactory.disconnectPropertyManager";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    Shiboken::Conversions::PythonToCppConversion pythonToCpp;
    SBK_UNUSED(pythonToCpp)
...
static const char *Sbk_QtSizeEditorFactory_PropertyStrings[] = {
    nullptr // Sentinel
};

static PyMethodDef Sbk_QtSizeEditorFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtSizeEditorFactoryFunc_connectPropertyManager), METH_O, nullptr},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtSizeEditorFactoryFunc_createAttributeEditor), METH_VARARGS, nullptr},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtSizeEditorFactoryFunc_createEditor), METH_VARARGS, nullptr},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtSizeEditorFactoryFunc_disconnectPropertyManager), METH_O, nullptr},

    {nullptr, nullptr, 0, nullptr} // Sentinel
};

static int Sbk_QtSizeEditorFactory_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    PySide::Feature::Select(self);
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::QtSizeEditorFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTSIZEEDITORFACTORY_IDX], reinterpret_cast<SbkObject *>(self)));
        auto inst = dynamic_cast<QtSizeEditorFactoryWrapper *>(plain_inst);
        if (inst)
...
// Class Definition -----------------------------------------------
extern "C" {
static PyTypeObject *_Sbk_QtSizeEditorFactory_Type = nullptr;
static PyTypeObject *Sbk_QtSizeEditorFactory_TypeF(void)
{
...
static PyType_Slot Sbk_QtSizeEditorFactory_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_QtSizeEditorFactory_setattro)},
...
static PyType_Spec Sbk_QtSizeEditorFactory_spec = {
    "1:qtpropertybrowser.QtSizeEditorFactory",
    sizeof(SbkObject),
    0,
...
static PythonToCppFunc is_QtSizeEditorFactory_PythonToCpp_QtSizeEditorFactory_PTR_Convertible(PyObject *pyIn)
{
    ...
    if (PyObject_TypeCheck(pyIn, Sbk_QtSizeEditorFactory_TypeF()))
...
static const char *QtSizeEditorFactory_SignatureStrings[] = {
    "qtpropertybrowser.QtSizeEditorFactory(self,parent:PySide6.QtCore.QObject=0)",
    "qtpropertybrowser.QtSizeEditorFactory.connectPropertyManager(self,manager:qtpropertybrowser.QtSizePropertyManager)",
    "qtpropertybrowser.QtSizeEditorFactory.createAttributeEditor(self,manager:qtpropertybrowser.QtSizePropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide6.QtWidgets.QWidget,attribute:qtpropertybrowser.BrowserCol)->PySide6.QtWidgets.QWidget",
    "qtpropertybrowser.QtSizeEditorFactory.createEditor(self,manager:qtpropertybrowser.QtSizePropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide6.QtWidgets.QWidget)->PySide6.QtWidgets.QWidget",
    "qtpropertybrowser.QtSizeEditorFactory.disconnectPropertyManager(self,manager:qtpropertybrowser.QtSizePropertyManager)",
    nullptr}; // Sentinel
...
void init_QtSizeEditorFactory(PyObject *module)
{
    _Sbk_QtSizeEditorFactory_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        0,
        0);
    auto *pyType = Sbk_QtSizeEditorFactory_TypeF(); // references _Sbk_QtSizeEditorFactory_Type
    InitSignatureStrings(pyType, QtSizeEditorFactory_SignatureStrings);
    SbkObjectType_SetPropertyStrings(pyType, Sbk_QtSizeEditorFactory_PropertyStrings);
    SbkqtpropertybrowserTypes[SBK_QTSIZEEDITORFACTORY_IDX] = pyType;
