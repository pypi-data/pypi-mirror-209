...
class QtTreePropertyBrowser : public QtAbstractPropertyBrowser
{
    ...
    Q_PROPERTY(BrowserCol attributes READ attributes WRITE setAttributes)
public:
    /*!
      \enum ResizeMode
      ...
      \var Interactive
      The user can resize the sections.
      ...
      QHeaderView will automatically resize the section to its optimal
    ...
    */
    ...
    BrowserCol attributes() const;
    void setAttributes(BrowserCol attributes);
