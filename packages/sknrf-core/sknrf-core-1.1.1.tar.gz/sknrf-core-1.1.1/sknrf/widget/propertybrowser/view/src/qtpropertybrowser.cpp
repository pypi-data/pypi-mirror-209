...
/*!
    ...
    \brief A Private d_ptr of QtProperty.
...
{
public:
    QtPropertyPrivate(QtAbstractPropertyManager *manager) : m_label(""), m_enabled(true), m_modified(false), m_check(false), m_manager(manager) {}
    QtProperty *q_ptr;
...
/*!
    ...
    \brief A Private d_ptr of QtAbstractPropertyManager.
...
/*!
 \reimp
 */
QIcon QtAbstractPropertyManager::checkIcon(const QtProperty *property) const
{
    if (!attributeEditable(BrowserCol::CHECK))
        return {};
...
/*!
    ...
    \o setStatusTip()
    \row
    \o descriptionToolTip()
    \o setDescriptionToolTip()
    \row
    \o valueToolTip()
    \o setValueToolTip()
    \row
 ...
 */
bool QtAbstractPropertyManager::attributeEditable(const BrowserCol attribute) const
{
...
/*!
 ...
 \sa attributeEditable()
 */
void QtAbstractPropertyManager::setAttributeEditable(BrowserCol attribute, bool enable)
{
...
/*!
    ...
    new property, e.g. QtIntPropertyManager adds \l{QtIntPropertyManager::value(),value()}, \l{QtIntPropertyManager::minimum(),minimum()} and \l{QtIntPropertyManager::maximum(),maximum()} attributes. Since each manager
...
/*!
    ...
    \brief A Private d_ptr of QtBrowserItem.
...
/*!
    ...
    \brief A Private d_ptr of QtAbstractPropertyBrowser.

    \sa QtAbstractPropertyBrowser
*/
class QtAbstractPropertyBrowserPrivate
{
...
/*!
    ...
    \image html qtpropertybrowser.png "Qt Property Browser"
    ...
    \image html qtpropertybrowser-duplicate.png "Qt Property Browser"
