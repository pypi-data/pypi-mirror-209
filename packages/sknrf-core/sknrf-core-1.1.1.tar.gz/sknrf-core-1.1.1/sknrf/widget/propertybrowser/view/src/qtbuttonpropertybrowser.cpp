...
/*!
    ...
    \brief A Private d_ptr of QtButtonPropertyBrowser.

    \sa QtButtonPropertyBrowser
*/
class QtButtonPropertyBrowserPrivate
{
...
unsigned short QtButtonPropertyBrowserPrivate::numColumns() const
{
...
BrowserCol QtButtonPropertyBrowserPrivate::columnToAttribute(const int col) const
{
...
void QtButtonPropertyBrowserPrivate::setExpanded(WidgetItem *item, bool expanded)
{
    ...
    if (expanded) {
        insertRow(l, row + 1);
        l->addWidget(item->container, row + 1, 0, 1, numColumns());
        item->container->show();
    } else {
...
/*!
    ...
    \image html qtbuttonpropertybrowser.png "Qt Button Property Browser"
...
BrowserCol QtButtonPropertyBrowser::attributes() const
{
    return d_ptr->m_attributes;
}

void QtButtonPropertyBrowser::setAttributes(BrowserCol attributes)
{
