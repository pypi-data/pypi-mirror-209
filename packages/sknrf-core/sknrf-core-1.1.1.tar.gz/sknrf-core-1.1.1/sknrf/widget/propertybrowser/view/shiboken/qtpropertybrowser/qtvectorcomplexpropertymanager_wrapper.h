#ifndef SBK_QTVECTORCOMPLEXPROPERTYMANAGERWRAPPER_H
#define SBK_QTVECTORCOMPLEXPROPERTYMANAGERWRAPPER_H
...
class QtVectorComplexPropertyManagerWrapper : public QtVectorComplexPropertyManager
{
public:
    QtVectorComplexPropertyManagerWrapper(QObject * parent = 0);
    ...
    inline QString formatText_protected(const QtProperty * property) const { return QtVectorComplexPropertyManager::formatText(property); }
    ...
    inline void initializeProperty_protected(QtProperty * property) { QtVectorComplexPropertyManager::initializeProperty(property); }
    ...
    inline QString pkAvgText_protected(const QtProperty * property) const { return QtVectorComplexPropertyManager::pkAvgText(property); }
    QString pkAvgText(const QtProperty * property) const override;
    inline void reinitializeProperty_protected(QtProperty * property) { QtVectorComplexPropertyManager::reinitializeProperty(property); }
    ...
    inline void uninitializeProperty_protected(QtProperty * property) { QtVectorComplexPropertyManager::uninitializeProperty(property); }
    void uninitializeProperty(QtProperty * property) override;
    inline QString unitText_protected(const QtProperty * property) const { return QtVectorComplexPropertyManager::unitText(property); }
    ...
    inline QString valueText_protected(const QtProperty * property) const { return QtVectorComplexPropertyManager::valueText(property); }
    QString valueText(const QtProperty * property) const override;
    ~QtVectorComplexPropertyManagerWrapper();
public:
...
private:
    mutable bool m_PyMethodCache[25];
};
...
#endif // SBK_QTVECTORCOMPLEXPROPERTYMANAGERWRAPPER_H
