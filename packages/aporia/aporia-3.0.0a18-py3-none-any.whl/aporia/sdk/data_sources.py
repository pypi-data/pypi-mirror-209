...
class DataSource(BaseAporiaResource):
    ...
    def create(
        ...
        response = client.send_request(
            "/data-sources",
            "POST",
            {"name": name, "type": data_source_type.value, "connection": connection_data},
            # TODO: Hack until data-sources are creatable using stable API
    ...
    def delete(self):
        response = self.client.send_request(
            ...
            "DELETE",
            # TODO: Hack until data-sources are deleteable using stable API
            url_search_replace=("/api/v1/", "/v1/crud-service/"),
        )
        self.client.assert_response(response)
