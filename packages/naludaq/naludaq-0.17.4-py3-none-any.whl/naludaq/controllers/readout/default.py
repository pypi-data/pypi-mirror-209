...
class ReadoutController(Controller):
    ...
    def set_record_window(self, pre_trigger: int, record_length: int):
        ...
        write_after_trigger = max(record_length - pre_trigger, 2)
        self.set_read_window(
            windows=record_length,
            lookback=pre_trigger,
            write_after_trig=write_after_trigger,
        )

    def set_record_window_forced(self, start_window: int, record_length: int):
