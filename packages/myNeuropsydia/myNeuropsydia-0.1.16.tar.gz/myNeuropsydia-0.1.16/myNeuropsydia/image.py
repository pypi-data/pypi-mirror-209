    ...
    for i in files:
        ...
        if fullscreen is False:
            ...
            if unit == "n":  # size=1 means height is equals to 1
                if scale_by=="height":
                    new_w = int(w/h*size*scr.screen_height/20.0)
                    new_h = int(h/h*size*scr.screen_height/20.0)
                if scale_by=="width":
                    new_w = int(w/w*size*scr.screen_height/20.0)
                    new_h = int(h/w*size*scr.screen_height/20.0)
            ...
            if w > h:
                ...
                new_w = int(w/h*scr.screen_height)
                new_h = int(h/h*scr.screen_height)
...
def image(file, x=0, y=0, 
    ...
    *Dependencies*
    ...
    scr.screen.blit(image, rectangle)
