    ...
    *Dependencies*
    ...
    if fast is True:
        ...
        if style == 'body':
            ...
            if size == int(1.0*scr.screen_width/35.0):
                size = int(2.0*scr.screen_width/35.0)
            ...
            if size == int(1.0*scr.screen_width/35.0):
                size = int(1.5*scr.screen_width/35.0)
            font_name = Path.font() + 'RobotoBold.ttf'
            if y == 0:
                y=7
        elif style == 'end':
        ...
        if long_text is True:
            ...
            for i in range(len(text)):
                if i == (len(text) - 1):
                    ...
                    rectangle = surface.get_rect()
                    rectangle.center = (scr.screen_width/2, (surface.get_height()/2)+(line*surface.get_height()))
                    scr.screen.blit(surface, rectangle)
                    ...
                    if text[i] == " ":
                        ...
                        if surface_buffer.get_width()+scr.screen_width/4>scr.screen_width:
